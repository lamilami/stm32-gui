...
/*	OEM - Unicode,  OEM - Unicode,  OEM - Unicode,  OEM - Unicode */
	...
	#define SPI1_3 SPI3
#endif 
#define PAGE_PER_BYTES       (512)
#define CODE_GtoU_BASE_PAGE	 (594)
#define CODE_UtoG_BASE_PAGE	 (512)
/*************************************************************************************************************************
...
/*u16 GBKtoUNICODE(u16 GBKCode)
{
	...
	unicode *= 2;
	MMemPageRead(SPI1_3,CODE_GtoU_BASE_PAGE + unicode/PAGE_PER_BYTES, unicode%PAGE_PER_BYTES ,(u8 *)&buf, 2);
	//W25X16_Read(buff,CODE_GtoU_BASE + unicode,2) ; //读取码表
	return buf;
}
*/
unsigned short GBKtoUNICODE(unsigned short gbk_code)
{
    unsigned char ch,cl;
	unsigned int  offset;
	unsigned char buf[2];
   ...
   // return (ch<=0x7d && cl<=0xbe) ? mb_gb2uni_table[ch*0xbf+cl] : 0x1fff;
	 if((ch <= 0x7d) && (cl <= 0xbe))
	 {
	    offset = ch * 0xbf +cl;
		  offset *= 2;
		  MMemPageRead(SPI1_3,CODE_GtoU_BASE_PAGE + offset/PAGE_PER_BYTES, offset%PAGE_PER_BYTES ,buf, 2);
...
//	u16 res;
	...
	offset *= 2;
	MMemPageRead(SPI1_3,CODE_UtoG_BASE_PAGE + offset/PAGE_PER_BYTES, unicode%PAGE_PER_BYTES ,(unsigned char *)&buf, 2);
