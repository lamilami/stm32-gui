/**
  ******************************************************************************
  * @file    stm324xg_eval_audio_codec.h
  * @author  MCD Application Team
  * @version V1.0.2
  * @date    09-March-2012
  * @brief   This file contains all the functions prototypes for the 
  *          stm324xg_eval_audio_codec.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM324xG_EVAL_AUDIOCODEC_H
#define __STM324xG_EVAL_AUDIOCODEC_H
...
/** @defgroup STM324xG_EVAL_AUDIO_CODEC 
  * @{
  */    


/** @defgroup STM324xG_EVAL_AUDIO_CODEC_Exported_Types
  * @{
  */

/** @defgroup STM324xG_EVAL_AUDIO_CODEC_Exported_Constants
  * @{
  */ 
...
/* Uncomment the following line to use the default Codec_TIMEOUT_UserCallback() 
   function implemented in stm324xg_eval_audio_codec.c file.
...
/** @defgroup STM324xG_EVAL_AUDIO_CODEC_Exported_Macros
  * @{
  */ 
...
/** @defgroup STM324xG_EVAL_AUDIO_CODEC_Exported_Functions
  * @{
  */ 
...
/* Codec_TIMEOUT_UserCallback() function is called whenever a timeout condition 
   ...
   define USE_DEFAULT_TIMEOUT_CALLBACK in stm324xg_eval_audio_codec.h file.
   Typically the user implementation of this callback should reset I2C peripheral
   and re-initialize communication or in worst case reset all the application. */
uint32_t Codec_TIMEOUT_UserCallback(void);
 
#endif /* __STM324xG_EVAL_AUDIOCODEC_H */
