...
--------------------------
   - This driver supports STM32F4xx devices on STM324xG-EVAL (MB786) Evaluation boards.

   - Configure the options in file stm324xg_eval_audio_codec.h in the section CONFIGURATION.
...
/** @addtogroup STM324xG_EVAL_AUDIO_CODEC
  * @brief       This file includes the low layer driver for CS43L22 Audio Codec
  *              available on STM324xG-EVAL evaluation board(MB786).
  * @{
  */ 

/** @defgroup STM324xG_EVAL_AUDIO_CODEC_Private_Types
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM324xG_EVAL_AUDIO_CODEC_Private_Defines
  * @{
  */ 
...
/** @defgroup STM324xG_EVAL_AUDIO_CODEC_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM324xG_EVAL_AUDIO_CODEC_Private_Variables
  * @{
  */
...
/** @defgroup STM324xG_EVAL_AUDIO_CODEC_Private_Function_Prototypes
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM324xG_EVAL_AUDIO_CODEC_Private_Functions
  * @{
  */ 
