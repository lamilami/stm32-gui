...
int main(void)
{
  ...
  /* ---------------------------------------------------------------
    ...
    Generate 4 signals with 4 different delays:
       TIM2_CH1 delay = CCR1_Val/TIM2 counter clock = 500 ms
       TIM2_CH2 delay = CCR2_Val/TIM2 counter clock = 250 ms
       TIM2_CH3 delay = CCR3_Val/TIM2 counter clock = 125 ms
       TIM2_CH4 delay = CCR4_Val/TIM2 counter clock = 62.5 ms
