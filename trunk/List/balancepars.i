#line 1 "Source\\gui_app\\BalancePars.c"
...
#line 2 "Source\\gui_app\\BalancePars.c"
#line 3 "Source\\gui_app\\BalancePars.c"
...
{
	int i,j,k;
	tbalance_pars.test_mode = RADIO_GetValue(WM_GetDialogItem(pMsg->hWin,0x800+15));
	if(tbalance_pars.test_mode == 0)
	{
	 for(i=0x800+6;i< 0x800+13+1;i++)
...
void OnButtonOK(WM_MESSAGE * pMsg)
{
	...
	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+1),tbalance_pars.tcustormer.custorm, sizeof(tbalance_pars.tcustormer.custorm));
	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+6),tbalance_pars.tcustormer.series_no, sizeof(tbalance_pars.tcustormer.series_no));
	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+2),tbalance_pars.tcustormer.elevator_productor, sizeof(tbalance_pars.tcustormer.elevator_productor));
    
	tbalance_pars.base_value = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+14));

	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+4),get_value,5);
	...
	if(tbalance_pars.test_mode == 0)
	{
	 ...
	 tbalance_pars.first_value = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+6)); 
	 
	 tbalance_pars.second_value = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+7));
	
	 tbalance_pars.third_value = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+8));

	 tbalance_pars.forth_value = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+9));

	 tbalance_pars.fifth_value = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+10));

	 tbalance_pars.sixth_value = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+11));

	 tbalance_pars.seventh_value = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+12));

	 tbalance_pars.eighth_value = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+13));				 	 
	}
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate_balance_pars[] = {
    ...
    { TEXT_CreateIndirect,      "客户名称",              0x800+17,            56, 82, 72, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+1,         147,77, 193,21, 0,0},
    { TEXT_CreateIndirect,      "电梯序号",              0x800+18,            56, 113,72, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+5,      147,108,193,21, 0,0},
    { TEXT_CreateIndirect,      "电梯制造商",             0x800+19,            56, 144,88, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+2,         147,139,193,21, 0,0},
    { TEXT_CreateIndirect,      "保留",                0x800+20,            63, 173,40, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+3,        147,168,193,21, 0,0},
    { RADIO_CreateIndirect,      0,               0x800+15,  56, 327,81, 38, 0,2},
    { TEXT_CreateIndirect,      "次",                 0x800+21,            425,327,24, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+4, 358,322,61, 21, 0,0},
    { TEXT_CreateIndirect,      "测试方式",              0x800+23,            56, 303,72, 16, 0,0},
    { TEXT_CreateIndirect,      "用户信息",              0x800+22,            56, 45, 72, 16, 0,0},
    { BUTTON_CreateIndirect,    "OK",                0x800+16,    616,355,165,92, 0,0},
    { TEXT_CreateIndirect,      "按标准测试测试次数",         0x800+24,            200,327,152,16, 0,0},
    { TEXT_CreateIndirect,      "额定载荷",              0x800+27,            56, 238,72, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+14,  147,233,61, 21, 0,0},
    { TEXT_CreateIndirect,      "kg",                0x160,            214,238,24, 16, 0,0},
    { TEXT_CreateIndirect,      "升降次序",            0x800+26,           502,41, 56, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+6,       562,60, 61, 21, 0,0},
    { TEXT_CreateIndirect,      "对重重量",          0x800+25,            562,41, 72, 16, 0,0},
    { TEXT_CreateIndirect,      "kg",                0x160,            642,41, 24, 16, 0,0},
    { TEXT_CreateIndirect,      "1",                 0x160,            515,65, 16, 16, 0,0},
    { TEXT_CreateIndirect,      "2",                 0x160,            515,99, 16, 16, 0,0},
    { TEXT_CreateIndirect,      "3",                 0x160,            515,133,16, 16, 0,0},
    { TEXT_CreateIndirect,      "4",                 0x160,            515,167,16, 16, 0,0},
    { TEXT_CreateIndirect,      "5",                 0x160,            515,201,16, 16, 0,0},
    { TEXT_CreateIndirect,      "6",                 0x160,            515,235,16, 16, 0,0},
    { TEXT_CreateIndirect,      "7",                 0x160,            515,269,16, 16, 0,0},
    { TEXT_CreateIndirect,      "8",                 0x160,            515,303,16, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+7,      562,94, 61, 21, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+8,       562,128,61, 21, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+9,      562,162,61, 21, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+10,       562,196,61, 21, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+11,       562,230,61, 21, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+12,     562,264,61, 21, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+13,     562,301,61, 21, 0,0}
};
...
void InitDialog_balance_pars(WM_MESSAGE * pMsg)
{
	...
	for(i = 0x800+17; i< 0x800+27+1;i++)
	{ 
    TEXT_SetFont(WM_GetDialogItem(hWin,i),&GUI_FontHZ_SongTi_16);
	}
    
    
    RADIO_SetGroupId(WM_GetDialogItem(hWin,0x800+15),0);
	
    RADIO_SetText(WM_GetDialogItem(hWin,0x800+15),"Stand Test",0);
    RADIO_SetText(WM_GetDialogItem(hWin,0x800+15),"Self Test",1);

	RADIO_SetValue(WM_GetDialogItem(hWin,0x800+15),tbalance_pars.test_mode);
	

	
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+14),tbalance_pars.base_value,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+14),tbalance_pars.first_value,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+14),tbalance_pars.second_value,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+14),tbalance_pars.third_value,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+14),tbalance_pars.forth_value,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+14),tbalance_pars.fifth_value,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+14),tbalance_pars.sixth_value,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+14),tbalance_pars.seventh_value,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+14),tbalance_pars.eighth_value,0,99999,3,2);

	EDIT_SetText(WM_GetDialogItem(hWin,0x800+1),tbalance_pars.tcustormer.custorm);
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+5),tbalance_pars.tcustormer.series_no);
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+2),tbalance_pars.tcustormer.elevator_productor);
        ...
        case 38:
            ...
            switch (Id) 
            {
                ...
                case 0x800+2:
                    switch(NCode)
                    {
                        case 1:
							...
							UseKeyBoard(pMsg,2 ,0x800+1,Id,CHINESE);
                            break;
                    }
                    break;
		        ...
		        case 0x800+5:
                    ...
                    {
                        case 1:
                            UseKeyBoard(pMsg,2 ,0x800+4,Id,ENGLISH_S);
                            break;
                    }
                    break;
                ...
                case 0x800+13:
                    ...
                    {
                        case 2:
                            UseKeyBoard(pMsg,0x800+13 - 0x800+6+1  ,0x800+6,Id,SFLOAT);
                            break;
                    }
                    break;
				...
				case 0x800+14:
                    ...
                    {
                        case 2:
                            UseKeyBoard(pMsg,1,0x800+14,Id,SFLOAT);
                            break;
                    }
                    break;
...
{ 
    ...
    current_handle = GUI_CreateDialogBox(_aDialogCreate_balance_pars, (sizeof(_aDialogCreate_balance_pars) / sizeof(_aDialogCreate_balance_pars[0])), &_cbCallback_balance_pars, 0, 0, 0);
}
