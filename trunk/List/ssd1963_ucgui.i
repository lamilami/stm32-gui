...
#line 2 "Source\\uCGUI\\LCDDriver\\ssd1963_ucgui.c"
...
#line 3 "Source\\uCGUI\\LCDDriver\\ssd1963_ucgui.c"
#line 4 "Source\\uCGUI\\LCDDriver\\ssd1963_ucgui.c"
#line 1 ".\\Source\\uCGUI\\Config\\LCD_Config.h"
...
#line 2 ".\\Source\\uCGUI\\Config\\LCD_Config.h"
...
#line 5 "Source\\uCGUI\\LCDDriver\\ssd1963_ucgui.c"
...
void LCD_L0_XorPixel(int x, int y)
{
  unsigned short Index = LCD_GetPoint(x,y);
  LCD_SetPoint(x,y,(1L<<(16))-1-Index);
}

void LCD_L0_DrawHLine  (int x0, int y,  int x1)
{
  GUI_Line(x0,y,x1,y,GUI_Context . LCD . aColorIndex16[1]);
}

void LCD_L0_DrawVLine  (int x, int y0,  int y1)
{
  GUI_Line(x,y0,x,y1,GUI_Context . LCD . aColorIndex16[1]);
}
...
void DrawBitLine1BPP(int x, int y, unsigned char const*p, int Diff, int xsize, const unsigned short*pTrans)
{
  ...
  pixels = *p;
  switch (GUI_Context.DrawMode & ((1<<1)|(1<<0))) {
  case 0:
...
static void  DrawBitLine2BPP(int x, int y, unsigned char const*p, int Diff, int xsize, const unsigned short*pTrans) {
  unsigned short pixels;
  ...
  if (pTrans) {
    ...
    if (GUI_Context.DrawMode & (1<<1)) switch (Diff&3) {
    case 0:
      goto WriteTBit0;
    case 1:
      goto WriteTBit1;
...
static void  DrawBitLine4BPP(int x, int y, unsigned char const*p, int Diff, int xsize, const unsigned short*pTrans)
{
  unsigned short pixels;
...
void DrawBitLine8BPP(int x, int y, unsigned char const*p, int xsize, const unsigned short*pTrans) {
  unsigned short pixel;
  if ((GUI_Context.DrawMode & (1<<1))==0) {
    if (pTrans) {
...
void DrawBitLine16BPP(int x, int y, unsigned short const*p, int xsize)
{
