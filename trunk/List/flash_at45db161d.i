...
#line 2 "Source\\APP\\flash_AT45DB161D.c"
...
void spi_at45db161d_initial(void)
{
#line 76 "Source\\APP\\flash_AT45DB161D.c"
}
...
{
	while (SPI_I2S_GetFlagStatus(SPIx, ((uint16_t)0x0002)) == RESET);
	SPI_I2S_SendData(SPIx,spi_send);

	while (SPI_I2S_GetFlagStatus(SPIx, ((uint16_t)0x0001)) == RESET);
...
{
    uint16_t i;
	do{GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0008));} while(0);;
    ...
    do{GPIO_SetBits (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0008)); }while(0);;
}
...
Error_status BufToMainMemPage(SPI_TypeDef *SPIx,uint8_t buf_Erase, uint16_t Pageaddr)
{
	...
	temp = (uint8_t)(Pageaddr >> 6); 
	SPI_WrRd_byte(SPIx, temp);
	temp = (uint8_t)(Pageaddr << 2); 
	SPI_WrRd_byte(SPIx, temp);
...
Error_status MMemPageRead(SPI_TypeDef *SPIx,uint16_t Pageaddr, uint16_t Byteaddr ,uint8_t *data_buf, uint16_t data_num)
{
	...
	FlashWaitBusy(SPIx);
	do{GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0008));} while(0);;
	SPI_WrRd_byte(SPIx, 0xd2);	 
	SPI_WrRd_byte(SPIx, (uint8_t)(Pageaddr>>6));	 
	SPI_WrRd_byte(SPIx, (uint8_t)((Pageaddr << 2)|(Byteaddr >> 8)&0x3)); 
	SPI_WrRd_byte(SPIx, (uint8_t)Byteaddr);	
...
Error_status MemPageToBUFF(SPI_TypeDef *SPIx,uint8_t buffer_num,uint16_t Pageaddr)
{
	...
	FlashWaitBusy(SPIx);
	do{GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0008));} while(0);;
	SPI_WrRd_byte(SPIx, buffer_num);	 
	SPI_WrRd_byte(SPIx, (uint8_t)(Pageaddr >>6));	 
	SPI_WrRd_byte(SPIx, (uint8_t)(Pageaddr << 2));    
	SPI_WrRd_byte(SPIx, 0x00);        
	do{GPIO_SetBits (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0008)); }while(0);;
	FlashWaitBusy(SPIx);
	return OP_OK;	
...
{
    if(pageaddr >= 4096u) return PageOver;
	FlashWaitBusy(SPIx);
	do{GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0008));} while(0);;
	SPI_WrRd_byte(SPIx,0X81);
