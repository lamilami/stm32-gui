...
#line 1 "Source\\Net\\tftp_server.h"
...
#line 3 "Source\\Net\\tftp_server.c"
#line 1 "Source\\Net\\ip_arp_udp_tcp.h"
...
#line 4 "Source\\Net\\tftp_server.c"
...
#line 5 "Source\\Net\\tftp_server.c"
...
#line 6 "Source\\Net\\tftp_server.c"
#line 7 "Source\\Net\\tftp_server.c"
#line 1 ".\\Source\\SDHC\\driver\\sdcard.h"
...
#line 36 ".\\Source\\SDHC\\driver\\sdcard.h"
...
#line 123 ".\\Source\\SDHC\\driver\\sdcard.h"




#line 134 ".\\Source\\SDHC\\driver\\sdcard.h"



 
#line 146 ".\\Source\\SDHC\\driver\\sdcard.h"


 
#line 160 ".\\Source\\SDHC\\driver\\sdcard.h"
...
#line 253 ".\\Source\\SDHC\\driver\\sdcard.h"
...
#line 8 "Source\\Net\\tftp_server.c"
...
#line 9 "Source\\Net\\tftp_server.c"
...
#line 10 "Source\\Net\\tftp_server.c"
...
char error_exc(unsigned char* buf,S_ERROR err_code)
{
	...
	make_udp_reply_from_request(buf,sbuf,20,69);	
	return 0;
}
...
char rrq_wrq_exc(unsigned char* buf)
{
	...
	int br;
	unsigned char res;
	tftp_pack.op_code = *(buf+0x2B);

	
	for(i=0;*(buf+(0x2B+1)+i)!='\0';i++)
	 tftp_pack.file_name[i] = *(buf+(0x2B+1)+i);

	if(tftp_pack.op_code == RRQ)
   {
	res = f_open(&fsrc,tftp_pack.file_name,0x01) ;
	if(res)
	{
	...
	for(j=0; (*(buf+(0x2B+1)+1+i+j)!='\0')&&(j<10);j++)
	tftp_pack.mode[j] =	*(buf+(0x2B+1)+i+1+j);
...
char data_exc(unsigned char* buf)
{
	...
	make_udp_reply_from_request(buf,packet,tftp_pack.current_file_size+4,69);
