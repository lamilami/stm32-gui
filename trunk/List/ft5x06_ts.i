...
#line 19 "Source\\BSP\\ft5x06_ts.c"
#line 20 "Source\\BSP\\ft5x06_ts.c"
...
void FT5x06_GPIO_Config(void)
{
  ...
  RCC_APB1PeriphClockCmd(((uint32_t)0x00200000),ENABLE);
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000008),ENABLE);
    
   
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_10MHz; 
	GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x0040) | ((uint16_t)0x0080); 
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_OD;  
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), &GPIO_InitStructure);

	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0040));
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), ((uint16_t)0x0080));
}
...
{
	int id,ver;
	id = FT_IIC_RegRead(0xa3);
	if (id != 0xA3) {
		printf("ID %d not supported\r\n", id);
		return 0;
	}
	ver = FT_IIC_RegRead(0xa6);
	if (ver < 0) {
...
void FT5x06_GetData(int* x, int* y)
{
	...
	{
		  Xposition_H=FT_IIC_RegRead(0x03);
		  Xposition_L=FT_IIC_RegRead(0x04);
		  Xposition = (Xposition_H&0x0f)*256+Xposition_L;
		  Yposition_H=FT_IIC_RegRead(0x05);
		  Yposition_L=FT_IIC_RegRead(0x06);
