...
#line 27 "Source\\uCOS-II\\Ports\\os_cpu_c.c"
...
#line 28 "Source\\uCOS-II\\Ports\\os_cpu_c.c"
...
#line 313 "Source\\uCOS-II\\Ports\\os_cpu_c.c"
}
...
void  OS_CPU_SysTickInit (void)
{
    ...
    cnts = OS_CPU_SysTickClkFreq() / 1000u;

    (*((volatile INT32U *)0xE000E014)) = (cnts - 1);
                                                  
    (*((volatile INT32U *)0xE000E010))  |= 0x00000004 | 0x00000001;
                                                  
    (*((volatile INT32U *)0xE000E010))  |= 0x00000002;
}
