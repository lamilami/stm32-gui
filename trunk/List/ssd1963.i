...
#line 2 "Source\\uCGUI\\LCDDriver\\SSD1963.c"
...
#line 3 "Source\\uCGUI\\LCDDriver\\SSD1963.c"
...
#line 4 "Source\\uCGUI\\LCDDriver\\SSD1963.c"
...
void LCD_WriteCom(u16 LCD_Reg)
{
	*((volatile unsigned short *)(0x60000000))  =LCD_Reg;
}
...
void LCD_WriteRAM(u16 RGB_Code)					 
{
  	...
  	*((volatile unsigned short *)(0x60080000))	 =RGB_Code;
}
...
u16 LCD_ReadRAM(void)
{
	u16 dummy;
  	...
  	*((volatile unsigned short *)(0x60000000))	 = 0x002e;
  	 
  	dummy  =  *((volatile unsigned short *)(0x60080000));
  	return dummy;
}
...
{
	*((vu16 *)0x60000000) = 0;
	*((vu16 *)(0x60000000+(0x00080000))) = y>>8;
	*((vu16 *)(0x60000000+(0x00080000))) = y;
	*((vu16 *)0x60000000) = 1;
	*((vu16 *)(0x60000000+(0x00080000))) = x>>8;
	*((vu16 *)(0x60000000+(0x00080000))) = x;
	*((vu16 *)0x60000000) = 2;
} 
void TimeDelay(u32 Time)
{
...
int GUI_GetVLine(u16 x0, u16 y0,u16 y1,u16 *color)
{
	...
	length=y1-y0+1;  
 	...
 	for(i=0;i<length;i++)      
	color[i]  =  *((volatile unsigned short *)(0x60080000));
