#line 1 "Source\\gui_app\\TParameter.c"
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate_tpar[] = {
    ...
    { TEXT_CreateIndirect,      "初速度V0:",            0x800+31,         123,51, 80, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+7,         128,67, 70, 21, 0,0},

    { BUTTON_CreateIndirect,    "OK",                0x800+52,               239,415,88, 42, 0,0},
    { BUTTON_CreateIndirect,    "Cancel",            0x170,          341,415,88, 42, 0,0},

    { TEXT_CreateIndirect,      "初始时间t0:",           0x800+32,         226,51, 96, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+8,         233,67, 70, 21, 0,0},

    { TEXT_CreateIndirect,      "ms",                0x800+11,            186,233,17, 12, 0,0},
    { TEXT_CreateIndirect,      "上升时间t1:",           0x800+39,         5,  233,96, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+16,         107,227,70, 21, 0,0},

    { TEXT_CreateIndirect,      "ms",                0x800+11,            186,273,17, 12, 0,0},
    { TEXT_CreateIndirect,      "持续时间t2:",           0x800+40,         208,232,96, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+17,         310,228,70, 21, 0,0},

    { TEXT_CreateIndirect,      "m/s",               0x800+11,            386,352,23, 12, 0,0},
    { TEXT_CreateIndirect,      "振动频率Hz:",            0x800+45,          11, 346,88, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+22,          107,343,70, 21, 0,0},

    { TEXT_CreateIndirect,      "振动幅度Vp:",           0x800+46,         213,348,96, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+23,         310,347,70, 21, 0,0},
    { TEXT_CreateIndirect,      "额定速度Ve:",           0x800+29,         11, 51, 96, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+6,         16, 67, 70, 21, 0,0},
    { TEXT_CreateIndirect,      "m/s",               0x800+11,            203,73, 23, 12, 0,0},
    { TEXT_CreateIndirect,      "节经r:",              0x800+28,          350,7,  56, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+5,       341,64, 70, 21, 0,0},
    { TEXT_CreateIndirect,      "mm",                0x800+11,            417,29, 17, 12, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+3,          234,26, 70, 21, 0,0},
    { TEXT_CreateIndirect,      "保留3:",              0x800+47,        350,48, 56, 16, 0,0},
    { TEXT_CreateIndirect,      "外径R:",              0x800+30,          238,7,  56, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+4,          341,24, 70, 21, 0,0},
    { CHECKBOX_CreateIndirect,  "多曲线显示",             0x800+49,             19, 415,107,20, 0,0},
    { TEXT_CreateIndirect,      "ms",                0x800+11,            310,70, 17, 12, 0,0},
    { TEXT_CreateIndirect,      "下降时间t3:",           0x800+41,         6,  269,96, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+18,         107,268,70, 21, 0,0},
    { TEXT_CreateIndirect,      "ms",                0x800+11,            389,233,17, 12, 0,0},
    { TEXT_CreateIndirect,      "m/s",               0x800+11,            386,273,23, 12, 0,0},
    { TEXT_CreateIndirect,      "跳变量dV:",            0x800+42,         221,269,80, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+19,         310,268,70, 21, 0,0},
    { TEXT_CreateIndirect,      "保留2:",              0x800+44,       233,305,56, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+21,       310,304,70, 21, 0,0},
    { TEXT_CreateIndirect,      "xx",                0x800+11,            389,309,17, 12, 0,0},
    { TEXT_CreateIndirect,      "xx",                0x800+11,            417,70, 17, 12, 0,0},
    { TEXT_CreateIndirect,      "ms",                0x800+11,            186,352,17, 12, 0,0},
    { TEXT_CreateIndirect,      "mm",                0x800+11,            90, 29, 17, 12, 0,0},
    { TEXT_CreateIndirect,      "速度V1:",             0x800+33,         21, 114,64, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+9,         107,111,70, 21, 0,0},
    { TEXT_CreateIndirect,      "速度V2:",             0x800+34,         229,110,64, 16, 0,0},
    { TEXT_CreateIndirect,      "m/s",               0x800+11,            183,114,23, 12, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+10,         310,109,70, 21, 0,0},
    { TEXT_CreateIndirect,      "m/s",               0x800+11,            386,114,23, 12, 0,0},

	{ TEXT_CreateIndirect,      "加速度a1:",            0x800+35,         13, 154,80, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+12,         107,150,70, 21, 0,0},
    { TEXT_CreateIndirect,      "m2/s",              0x800+11,            180,154,29, 12, 0,0},

    { TEXT_CreateIndirect,      "加速度a2:",            0x800+36,         221,150,80, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+13,         310,149,70, 21, 0,0},
    { TEXT_CreateIndirect,      "m2/s",              0x800+11,            383,154,29, 12, 0,0},

    { TEXT_CreateIndirect,      "加速度a3:",            0x800+37,         13, 194,80, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+14,         107,189,70, 21, 0,0},
    { TEXT_CreateIndirect,      "m2/s",              0x800+11,            180,194,29, 12, 0,0},
    { TEXT_CreateIndirect,      "保留0:",              0x800+38,       233,190,56, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+15,       310,189,70, 21, 0,0},
    { TEXT_CreateIndirect,      "xx",                0x800+11,            389,194,17, 12, 0,0},
    { TEXT_CreateIndirect,      "保留1:",              0x800+43,       25, 309,56, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+20,       107,301,70, 21, 0,0},
    { TEXT_CreateIndirect,      "xx",                0x800+11,            186,309,17, 12, 0,0},
    { TEXT_CreateIndirect,      "编码器R:",             0x800+25,       14, 7,  72, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+1,       16, 26, 70, 21, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+2,       128,26, 70, 21, 0,0},
    { TEXT_CreateIndirect,      "编码器线N:",            0x800+26,       123,7,  88, 16, 0,0},
    { TEXT_CreateIndirect,      "n",                 0x800+11,            203,33, 11, 12, 0,0},
    { TEXT_CreateIndirect,      "mm",                0x800+11,            310,33, 17, 12, 0,0},
    { TEXT_CreateIndirect,      "m/s",               0x800+11,            90, 73, 23, 12, 0,0}
...
{
	ttpars.enc_r = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+1));
	ttpars.enc_n = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+2));
	
	ttpars.r_mm = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+4));
	ttpars.Ve = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+6));
	ttpars.R_mm = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+3));
	ttpars.start_speed = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+7));
	
	ttpars.V1 = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+9));
	ttpars.V2 = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+10));

	ttpars.a1 = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+12));
	ttpars.a2 = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+13));
	ttpars.a3 = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+14));

	ttpars.t0 = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+8));
	ttpars.t1 = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+16));
	ttpars.t2 = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+17));
	ttpars.t3 = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+18));
...
{
	disp_mult = CHECKBOX_GetState(WM_GetDialogItem(pMsg->hWin,0x800+49));
}
...
void InitDialog_tpar(WM_MESSAGE * pMsg)
{
	...
	for(i= 0x800+25;i<  0x800+48+1;i++)
    TEXT_SetFont(WM_GetDialogItem(hWin,i),&GUI_FontHZ_SongTi_16);


    
	CHECKBOX_SetFont(WM_GetDialogItem(hWin,0x800+49),&GUI_FontHZ_SongTi_16);
    CHECKBOX_SetText(WM_GetDialogItem(hWin,0x800+49),"多曲线显示");
    
 

	for(i= 0x800+1 ;i< 0x800+24+1;i++)
	{ 
	
	}

	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+1),ttpars.enc_r,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+2),ttpars.enc_n,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+4),ttpars.r_mm,0,99999,3,2);

	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+3),ttpars.R_mm,0,99999,3,2);

	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+6),ttpars.Ve,0,99999,3,2);

	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+7),ttpars.start_speed,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+8),ttpars.t0,0,99999,3,2);
	
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+9),ttpars.V1,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+10),ttpars.V2,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+12),ttpars.a1,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+13),ttpars.a2,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+14),ttpars.a3,0,99999,3,2);
	
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+16),ttpars.t1,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+17),ttpars.t2,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+18),ttpars.t3,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+19),ttpars.dV,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+22),ttpars.HZ,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+23),ttpars.Vp,0,99999,3,2);
	
	WM_DisableWindow(WM_GetDialogItem(hWin,0x800+15));
	WM_DisableWindow(WM_GetDialogItem(hWin,0x800+20));
	WM_DisableWindow(WM_GetDialogItem(hWin,0x800+21));
	WM_DisableWindow(WM_GetDialogItem(hWin,0x800+5));
	WM_DisableWindow(WM_GetDialogItem(hWin,0x800+24));
}
        ...
        case 38:
            ...
            switch (Id) 
            {
				...
				case 0x800+10:
					...
					if(NCode==2)
					{
					UseKeyBoard(pMsg,0x800+1 -0x800+10+1 ,0x800+1,Id,SFLOAT);
					break;
					}
					break;
				...
				case 0x800+19:
						...
						if(NCode==2)
					{
					UseKeyBoard(pMsg,0x800+12 -0x800+19+1 ,0x800+12,Id,SFLOAT);
					break;
					}
					break;
...
{ 
    ...
    current_handle = GUI_CreateDialogBox(_aDialogCreate_tpar, (sizeof(_aDialogCreate_tpar) / sizeof(_aDialogCreate_tpar[0])), &_cbCallback_tpar, 0, 0, 0);
}
