#line 1 "Source\\gui_app\\Custormer.c"
...
#line 12 "Source\\gui_app\\Custormer.c"
...
#line 13 "Source\\gui_app\\Custormer.c"
...
#line 34 "Source\\gui_app\\Custormer.c"
...
void OnxxxClicked_Lprod(WM_MESSAGE * pMsg)
{
	...
	WidgetLock(pMsg->hWin,LOCK,10,0x800,0x800+10);
	KeyBoard_Win(&keyboard_h);
	WidgetLock(pMsg->hWin,UNLOCK,10,0x800,0x800+10);
	
	EDIT_SetFont(WM_GetDialogItem(pMsg->hWin, 0x800+10), &GUI_FontHZ_SongTi_16);
	EDIT_SetText(WM_GetDialogItem(pMsg->hWin, 0x800+10), keyboard_h.res_ch_data_head);
...
void OnButtonClicked_Next(WM_MESSAGE * pMsg)
{
	...
	if(h_pars == 0)
	{
	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+4), custormer.custorm, sizeof(custormer.custorm));
	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+5), custormer.elevator_productor, sizeof(custormer.elevator_productor));
	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+6), custormer.series_no, sizeof(custormer.series_no));
	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+10), custormer.limitor_productor, sizeof(custormer.limitor_productor));
	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+12), custormer.limitor_series, sizeof(custormer.limitor_series));
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate_Cus[] = {
    ...
    { TEXT_CreateIndirect,      "用  户",            0x800+1,            107,49, 56, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+4,            219,49, 245,21, 0,0},
    
    { TEXT_CreateIndirect,      "电梯制造商",        0x800+2,           107,96, 88, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+5,           219,91, 245,21, 0,0},
    { TEXT_CreateIndirect,      "电梯型号",          0x800+3,            107,152,72, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+6,            219,147,245,21, 0,0},

    { TEXT_CreateIndirect,      "限速器制造商",      0x800+9,            107,212,104,16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+10,            217,207,247,21, 0,0},
    { TEXT_CreateIndirect,      "限速器型号",        0x800+11 ,             107,265,88, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+12,            217,260,247,21, 0,0},
    { BUTTON_CreateIndirect,    "OK",                0x800+8,         585,300,88, 42, 0,0},
...
void InitDialog_Cus(WM_MESSAGE * pMsg)
{
	...
	EDIT_SetFont(WM_GetDialogItem(hWin,0x800+4),&GUI_FontHZ_SongTi_16);
	TEXT_SetFont(WM_GetDialogItem(hWin,0x800+3),&GUI_FontHZ_SongTi_16);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+4),500);
    
    
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+2),&GUI_FontHZ_SongTi_16);
	EDIT_SetFont(WM_GetDialogItem(hWin,0x800+5),&GUI_FontHZ_SongTi_16);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+5),500);
    
    
    

	TEXT_SetFont(WM_GetDialogItem(hWin,0x800+9),&GUI_FontHZ_SongTi_16);
	EDIT_SetFont(WM_GetDialogItem(hWin,0x800+10),&GUI_FontHZ_SongTi_16);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+10),500);
    ...
    BUTTON_SetFont(WM_GetDialogItem(hWin,0x800+7),&GUI_FontHZ_SongTi_16);

	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+12),500);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+6),500);
    
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+4),custormer.custorm);
	
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+5),custormer.elevator_productor);

	EDIT_SetText(WM_GetDialogItem(hWin,0x800+6),custormer.series_no);
	
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+10),custormer.limitor_productor);
	
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+12),custormer.limitor_series);
        ...
        case 38:
            ...
            switch (Id) 
            {
				...
				case 0x800+10:
                    ...
                    {
                        case 1:
							UseKeyBoard(pMsg,(0x800+10 - 0x800+1 +1),0x800,Id,CHINESE);  
                            break;
                    }
                    break;
				...
				case 0x800+12:
                    ...
                    {
                        case 1:
                            UseKeyBoard(pMsg,(0x800+10 - 0x800+1 +1),0x800,Id,ENGLISH_S);
                            break;
                    }
                    break;
                case 0x800+7:
...
{ 
    ...
    current_handle = GUI_CreateDialogBox(_aDialogCreate_Cus, (sizeof(_aDialogCreate_Cus) / sizeof(_aDialogCreate_Cus[0])), &_cbCallback_Cus, 0, 0, 0);
