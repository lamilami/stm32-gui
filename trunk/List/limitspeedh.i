#line 1 "Source\\gui_app\\LimitSpeedH.c"
...
#line 12 "Source\\gui_app\\LimitSpeedH.c"
...
#line 13 "Source\\gui_app\\LimitSpeedH.c"
...
#line 14 "Source\\gui_app\\LimitSpeedH.c"

#line 16 "Source\\gui_app\\LimitSpeedH.c"
#line 17 "Source\\gui_app\\LimitSpeedH.c"
#line 18 "Source\\gui_app\\LimitSpeedH.c"
#line 19 "Source\\gui_app\\LimitSpeedH.c"
#line 20 "Source\\gui_app\\LimitSpeedH.c"
#line 21 "Source\\gui_app\\LimitSpeedH.c"
#line 22 "Source\\gui_app\\LimitSpeedH.c"
#line 23 "Source\\gui_app\\LimitSpeedH.c"
#line 24 "Source\\gui_app\\LimitSpeedH.c"
#line 25 "Source\\gui_app\\LimitSpeedH.c"
#line 26 "Source\\gui_app\\LimitSpeedH.c"
...
#line 27 "Source\\gui_app\\LimitSpeedH.c"
#line 28 "Source\\gui_app\\LimitSpeedH.c"
...
#line 29 "Source\\gui_app\\LimitSpeedH.c"
...
#line 30 "Source\\gui_app\\LimitSpeedH.c"
...
#line 31 "Source\\gui_app\\LimitSpeedH.c"
...
#line 32 "Source\\gui_app\\LimitSpeedH.c"
...
#line 33 "Source\\gui_app\\LimitSpeedH.c"
#line 34 "Source\\gui_app\\LimitSpeedH.c"
...
#line 35 "Source\\gui_app\\LimitSpeedH.c"
...
#line 36 "Source\\gui_app\\LimitSpeedH.c"
#line 37 "Source\\gui_app\\LimitSpeedH.c"
#line 1 "Source\\gui_app\\LimitDraw.h"

#line 3 "Source\\gui_app\\LimitDraw.h"
#line 4 "Source\\gui_app\\LimitDraw.h"
#line 5 "Source\\gui_app\\LimitDraw.h"
#line 6 "Source\\gui_app\\LimitDraw.h"

#line 8 "Source\\gui_app\\LimitDraw.h"
#line 9 "Source\\gui_app\\LimitDraw.h"




#line 22 "Source\\gui_app\\LimitDraw.h"
...
#line 38 "Source\\gui_app\\LimitSpeedH.c"
...
GUI_HWIN hwin;
 ...
 GRAPH_DATA_Handle  _ahData[40];  
 unsigned int exist[40];
 GRAPH_SCALE_Handle _hScaleV;    
 GRAPH_SCALE_Handle _hScaleH;    

 signed short _aValue[40];

 GUI_COLOR _aColor[] = {0xFF0000,0x0000FF, 0x00FF00,0xFFFF00,0xFF00FF,0x00FFFF};

 int draw_buf_lim[380];
...
static void _UserDraw(GUI_HWIN hWin, int Stage) {
  if (Stage == 1) {
    char acText[] = "Speed";
    ...
    GUI_DispStringInRectEx(acText, &Rect, (2<<0), strlen(acText), &LCD_APIListCCW);
  }
}
...
#line 103 "Source\\gui_app\\LimitSpeedH.c"

#line 116 "Source\\gui_app\\LimitSpeedH.c"
...
void OnxxxClicked_DELET(WM_MESSAGE * pMsg)
{
	...
	{
	row_number = LISTVIEW_GetNumRows(WM_GetDialogItem(pMsg->hWin,0x800+7));
	
	row = LISTVIEW_GetSel(WM_GetDialogItem(pMsg->hWin,0x800+7));
	
	LISTVIEW_DeleteRow(WM_GetDialogItem(pMsg->hWin,0x800+7),row);
	
	for(i=0;i<row_number-1;i++)
	 {
	    j = row_number-1-i;
	    sprintf(buf,"%d",j);
		LISTVIEW_SetItemText(WM_GetDialogItem(current_handle,0x800+7),0,i,buf);
	 }
...
void OnxxxClicked_Start(WM_MESSAGE * pMsg)
{
	 ...
	 if((get_data.e_work_state != START_TEST)&&(get_data.e_work_state != GET_V1))
	  ...
	  lenth = LISTVIEW_GetNumRows(WM_GetDialogItem(pMsg->hWin,0x800+7));
	  ...
	  _ListBox[0]= buf;
	  LISTVIEW_InsertRow(WM_GetDialogItem(pMsg->hWin,0x800+7),0,_ListBox);
     ...
     if(pars.dir !=2)
	{
	BUTTON_SetText(WM_GetDialogItem(pMsg->hWin,0x800+5),"正转中");
	pars.dir = 1;
	}else {
	BUTTON_SetText(WM_GetDialogItem(pMsg->hWin,0x800+5),"反转中");	
	}
	motor_dir(pars.dir);

	BUTTON_SetText(WM_GetDialogItem(pMsg->hWin,0x800+6),"运行中");
    start_test_init();
	...
	tdraw.data_size = 0;
	 ...
	 all_button(0,0x800+10);
	 botton_able(1,0x800+6);
}
...
void OnxxxClicked_STOP(WM_MESSAGE * pMsg)
{
	...
	BUTTON_SetText(WM_GetDialogItem(pMsg->hWin,0x800+6),"停止");
	motor_dir(0);
	all_button(1,0x800+10 );
...
void OnxxxClicked_CR(WM_MESSAGE * pMsg)
{
    ...
    if(pars.dir == 1)
	{
	BUTTON_SetText(WM_GetDialogItem(pMsg->hWin,0x800+5),"反转");
	pars.dir = 2;
	}else {
	BUTTON_SetText(WM_GetDialogItem(pMsg->hWin,0x800+5),"正转");	
	pars.dir = 1;
	}
	motor_dir(pars.dir);
	}
...
void OnxxxClicked_SAVE(WM_MESSAGE * pMsg,ESaveState save_state)
{
	...
	char buf[10];
	hObj = WM_GetDialogItem(pMsg->hWin,0x800+7);
...
void delect_now_row(void)
{
	...
	LISTVIEW_DeleteRow(WM_GetDialogItem(current_handle,0x800+7),0);
	row_number = LISTVIEW_GetNumRows(WM_GetDialogItem(current_handle,0x800+7));
...
#line 346 "Source\\gui_app\\LimitSpeedH.c"
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate_Lim[] = {
    ...
    { BUTTON_CreateIndirect,    "开始",                0x800+8,          1, 8,  100,40, 0,0},
    { BUTTON_CreateIndirect,    "停止",                 0x800+6,          1, 57,100,40, 0,0},
    { BUTTON_CreateIndirect,    "正转/反转",             0x800+5,          1, 106, 100,40, 0,0},
    { BUTTON_CreateIndirect,    "删除",                0x800+10,         1, 155,100,40, 0,0},
    { BUTTON_CreateIndirect,    "参数设置",              0x800+1,         1, 302,100,40, 0,0},
    { BUTTON_CreateIndirect,    "保存",                0x800+3,          1, 204,100,40, 0,0},
    { BUTTON_CreateIndirect,    "打印",                0x800+2,          1, 253,100,40, 0,0},
    { BUTTON_CreateIndirect,    "客户",                0x800+9,          1, 351,100,40, 0,0},
    { BUTTON_CreateIndirect,    "主界面",               0x800+4,          1, 400,100,40, 0,0},
    { LISTVIEW_CreateIndirect,   0,               0x800+7,        104,8,280,432,0,0}
};
...
void InitDialog_Lim(WM_MESSAGE * pMsg)
{
	...
	char buf[8];
	GUI_ConstString _ListBox[] = {"1", "0", "0","E", "", "","R"};
    GUI_HWIN hWin = pMsg->hWin,hGraph = 0;
	GUI_HWIN hDlg, hItem;
	hDlg = pMsg->hWin;
	buf[0] = 'N';
	...
	BUTTON_SetFont(WM_GetDialogItem(hWin,0x800+15),&GUI_FontHZ_SongTi_16);
	...
	LISTVIEW_SetAutoScrollV(WM_GetDialogItem(hWin,0x800+7),1);

    LISTVIEW_SetFont(WM_GetDialogItem(hWin,0x800+7),&GUI_FontHZ_SongTi_16);
	
	LISTVIEW_SetRowHeight(WM_GetDialogItem(hWin,0x800+7),24);
	
    LISTVIEW_AddColumn(WM_GetDialogItem(hWin,0x800+7),30,"order",(3<<2)|(0<<0));
    LISTVIEW_AddColumn(WM_GetDialogItem(hWin,0x800+7),50,"V1",(3<<2)|(0<<0));
    LISTVIEW_AddColumn(WM_GetDialogItem(hWin,0x800+7),50,"V2",(3<<2)|(0<<0));
	LISTVIEW_AddColumn(WM_GetDialogItem(hWin,0x800+7),60,"Res",(3<<2)|(0<<0));
    LISTVIEW_AddColumn(WM_GetDialogItem(hWin,0x800+7),10,"---",(3<<2)|(0<<0));
	LISTVIEW_AddColumn(WM_GetDialogItem(hWin,0x800+7),10,"---",(3<<2)|(0<<0));
	LISTVIEW_AddColumn(WM_GetDialogItem(hWin,0x800+7),50,"Dir",(3<<2)|(0<<0));
	...
	LISTVIEW_AddRow(WM_GetDialogItem(hWin,0x800+7),_ListBox);
	
	}
	for(i=0;i< tget_record.act_record_lenth;i++)
	{
		if(tget_record.sig_record[i].state[0] == 'N')
		{
		list_view_color(0, i,0x8080FF); 
		}
	}
...
{ 
    ...
    current_handle = GUI_CreateDialogBox(_aDialogCreate_Lim, (sizeof(_aDialogCreate_Lim) / sizeof(_aDialogCreate_Lim[0])), &_cbCallback_Lim, 0, 0, 0);
	current_interface = 102;
}
...
void draw_xy(void)
{
	...
	tscale.x_pix_size = 380;
	tscale.y_pix_size = 413;
	...
	tscale.x_data_max = 600;

	
	tsepoint.start_point.x = 405;
	tsepoint.start_point.y = 435;
	tsepoint.end_point.x = tsepoint.start_point.x + 380;
	...
	tsepoint.end_point.y = tsepoint.start_point.y - 413;
	draw_scale(tsepoint,0xffff,0);		
...
void draw_init(void)
{
	...
	tdraw.p0.x = 405+10;
	tdraw.p0.y = 413+21;
	tdraw.p_rec_lu.x = 405;
	tdraw.p_rec_lu.y = 21;
	tdraw.p_rec_rd.x = 380+405;
	tdraw.p_rec_rd.y = 413+21;
	tdraw.draw_color = 0xFF0000;
...
if(current_interface == 102)
	rate = (413 )/(pars . ve*(1+0.5/pars . ve));
else
	rate = (413 )/(ttpars . Ve*(1+0.5/ttpars . Ve));

	value_pix = value*rate;
	mirro_y = (413+21-value_pix);
...
void list_view_color(unsigned Column, unsigned Row,GUI_COLOR Color)
{
	LISTVIEW_SetItemBkColor(WM_GetDialogItem(current_handle,0x800+7),Column,Row,0,Color);
}
...
void print_head(void)
{
	int i;
 	char ch[]="手持限速器";
	rdprint(0x1B);rdprint(0x38);rdprint(CH1212);;
