...
void set_contol(ESR_CLK sr_clk,ESR_STEP sr_step)
{
	...
	control = (1<<13)|(1<<12)|(sr_clk<<8)|(sr_step<<5)|(0<<4)|(0<<3)|6;
	
	SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)),0x55);
	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002))==0) {}
	out = (control>>8);
	SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)),out);
	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002))==0) {}
	out = (control&0x00FF);
	SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)),out);
	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002))==0) {}

	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0020));
	for(j=0;j<50;j++);
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0020));
}
...
void set_data(float ma)
{
	...
	SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)),1);
	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002))==0) {}
	out = 	(data>>8);
	SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)),out);
	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002))==0) {}
...
void reset(void)
{
	...
	SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)),2);
	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002))==0) {}
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0020));
	for(j=0;j<50;j++);
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0020));
...
unsigned int read(EREAD_KIND read_kind)
{
	...
	SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002)); 
	SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)),0x00);
	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002))==0) {}
	read_back = SPI_I2S_ReceiveData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)))<<16;
	SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)),0x00);
	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002))==0) {}
	read_back = read_back|(SPI_I2S_ReceiveData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)))<<8);
	SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)),0x00);
	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002))==0) {}
	read_back = read_back|SPI_I2S_ReceiveData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)));
