#line 1 "Source\\gui_app\\xyz_acc_para.c"
...
#line 5 "Source\\gui_app\\xyz_acc_para.c"
...
{
	xyz_pars.auto_sel = CHECKBOX_GetState(WM_GetDialogItem(pMsg->hWin,0x800+8));
}
...
void OnRadioButtonClicked(WM_MESSAGE * pMsg)
{
	...
	get_id = RADIO_GetValue(WM_GetDialogItem(pMsg->hWin,0x800+9));
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
    ...
    { TEXT_CreateIndirect,      "客户名称",              0x800+11,            88, 80, 72, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+1,         179,75, 193,21, 0,0},
    { TEXT_CreateIndirect,      "电梯序号",              0x800+12,            88, 111,72, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+6,      179,106,193,21, 0,0},
    { TEXT_CreateIndirect,      "电梯制造商",             0x800+13,            88, 142,88, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+2,         179,137,193,21, 0,0},
    { TEXT_CreateIndirect,      "保留",                0x800+14,            95, 176,40, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+3,        179,171,193,21, 0,0},
    { RADIO_CreateIndirect,      0,               0x800+9,     562,75, 175,117,0,6},

    { TEXT_CreateIndirect,      "记录方式",              0x800+15,            88, 226,72, 16, 0,0},
    { TEXT_CreateIndirect,      "开始记录门限",            0x800+16,            179,256,104,16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+4,     289,253,61, 21, 0,0},
    { TEXT_CreateIndirect,      "m2/s(Za)",          0x800+22,           356,256,53, 12, 0,0},
    { TEXT_CreateIndirect,      "结束记录门限",            0x800+17,            179,284,104,16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+5,      289,279,61, 21, 0,0},
    { TEXT_CreateIndirect,      "m2/s(Za)",          0x800+23,           356,282,53, 12, 0,0},
    { TEXT_CreateIndirect,      "定时记录",              0x800+18,            88, 352,72, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+7, 289,345,61, 21, 0,0},
    { TEXT_CreateIndirect,      "s",                 0x800+24,           356,350,11, 12, 0,0},
    { TEXT_CreateIndirect,      "记录时间",              0x800+19,            211,350,72, 16, 0,0},
    { CHECKBOX_CreateIndirect,  "自动",                0x800+8,             95, 255,59, 20, 0,0},
    { TEXT_CreateIndirect,      "滤波方式",              0x800+20,            562,43, 72, 16, 0,0},
    { TEXT_CreateIndirect,      "用户信息",              0x800+21,            88, 43, 72, 16, 0,0},
    { BUTTON_CreateIndirect,    "OK",                0x800+16,    619,399,165,54, 0,0}
...
static void InitDialog(WM_MESSAGE * pMsg)
{
	...
	WM_DisableWindow(WM_GetDialogItem(hWin,0x800+3));
	...
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+4),xyz_pars.auto_start_za,0,99999,3,2);
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+5),xyz_pars.auto_stop_za,0,99999,3,2);
    
    
	for(i=0x800+11;i<0x800+21+1;i++)
	{
    TEXT_SetFont(WM_GetDialogItem(hWin,i),&GUI_FontHZ_SongTi_16);
	}

	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+1),50);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+6),50);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+2),50);
	
	
    
    
    RADIO_SetGroupId(WM_GetDialogItem(hWin,0x800+9),0);
    RADIO_SetText(WM_GetDialogItem(hWin,0x800+9),"No Filter",0);
    RADIO_SetText(WM_GetDialogItem(hWin,0x800+9),"20Hz Low",1);
    RADIO_SetText(WM_GetDialogItem(hWin,0x800+9),"30Hz Low",2);
    RADIO_SetText(WM_GetDialogItem(hWin,0x800+9),"50Hz Low",3);
    RADIO_SetText(WM_GetDialogItem(hWin,0x800+9),"100Hz Low",4);
    RADIO_SetText(WM_GetDialogItem(hWin,0x800+9),"200Hz Low",5);

	
    
    
    CHECKBOX_SetText(WM_GetDialogItem(hWin,0x800+8),"自动");
    CHECKBOX_SetFont(WM_GetDialogItem(hWin,0x800+8),&GUI_FontHZ_SongTi_16);

	if(xyz_pars.auto_sel)
	{
	CHECKBOX_SetState(WM_GetDialogItem(hWin,0x800+8), 1);
	}

	EDIT_SetFont(WM_GetDialogItem(hWin,0x800+1),&GUI_FontHZ_SongTi_16);
	EDIT_SetFont(WM_GetDialogItem(hWin,0x800+2),&GUI_FontHZ_SongTi_16);

	EDIT_SetText(WM_GetDialogItem(hWin,0x800+1),xyz_cus.custorm);
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+6),xyz_cus.series_no);
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+2),xyz_cus.elevator_productor);

	sprintf(buf,"%d",xyz_pars.record_s);
	
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+7),buf);

	RADIO_SetValue(WM_GetDialogItem(hWin,0x800+9),xyz_pars.e_filter);
        ...
        case 38:
            ...
            switch (Id) 
            {
				...
				case 0x800+5:
                    ...
                    {
                        case 2:
                            UseKeyBoard(pMsg,2,0x800+4,Id,SFLOAT);
                            break;
                    }
                    break;
				...
				case 0x800+7:
                    ...
                    {
                        case 2:
                            UseKeyBoard(pMsg,2,0x800+6,Id,ENGLISH_B);
                            break;
                    }
                    break;
...
static void _ForEach(GUI_HWIN hWin, void * pData) 
{
...
void dialog_lock(GUI_HWIN hwin,void *pData)
{		 
    ELock_Unlock win_status;
	win_status = (ELock_Unlock)pData;
...
void OnButtonOKClicked(WM_MESSAGE * pMsg)
{
	...
	if(xyz_pars.auto_sel)
	{
	 xyz_pars.auto_start_za =  EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+4));
	 xyz_pars.auto_stop_za = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+5));
	}else{
	
	

	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+7),buf, 9);
	xyz_pars.record_s = atoi(buf);
	tdisp_acc_struct.acc_sample_seconds = xyz_pars.record_s;
	
	tdisp_acc_struct.acc_nums_of_one_pixel = (800*xyz_pars.record_s)/600;

	}
	
	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+1),xyz_cus.custorm, sizeof(xyz_cus.custorm));
	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+6),xyz_cus.series_no, sizeof(xyz_cus.series_no));
	EDIT_GetText(WM_GetDialogItem(pMsg->hWin, 0x800+2),xyz_cus.elevator_productor, sizeof(xyz_cus.elevator_productor));
