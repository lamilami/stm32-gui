#line 1 "Source\\gui_app\\gui_app.c"
...
#line 24 "Source\\gui_app\\gui_app.c"
...
#line 26 "Source\\gui_app\\gui_app.c"
...
#line 27 "Source\\gui_app\\gui_app.c"
#line 1 ".\\Source\\BSP\\rtc.h"
...
#line 28 "Source\\gui_app\\gui_app.c"

#line 31 "Source\\gui_app\\gui_app.c"
...
#line 34 "Source\\gui_app\\gui_app.c"
...
#line 35 "Source\\gui_app\\gui_app.c"
#line 37 "Source\\gui_app\\gui_app.c"
#line 38 "Source\\gui_app\\gui_app.c"
...
void file_init(void)
{
	...
	unsigned int i, bw;
		...
		f_mount(0, &fs);								  
		res = f_open(&fsrc, "speed_old.lt",0x10|0x02 |0x01) ;
...
void save_custormer(void)
{
	...
	res = f_open(&fsrc, "speed.lt",0x10|0x02 |0x01) ;
...
void read_parameters(void)
{
	...
	res = f_lseek(&fsrc, fsrc.fsize - sizeof(TPars) - sizeof(TGetRecord));
...
void get_data_form_file( char* file_name, void* pstru, unsigned int off_set,unsigned int size)
{
	...
	f_mount(0, &fs);								  
	res = f_open(&fsrc, file_name,0x10| 0x02 |0x01) ;
	if(res)
	{
		while(1);
	}
