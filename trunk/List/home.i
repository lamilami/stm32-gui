...
#line 12 "Source\\gui_app\\home.c"


void OnButtonClicked_B(WM_MESSAGE * pMsg)
{
	balance_pars(pMsg);
}

void OnButtonClicked_A(WM_MESSAGE * pMsg)
{
  	xyz_acc_parameter(pMsg);
}

void OnButtonClicked_H(WM_MESSAGE * pMsg)
{
	if(h_cus == 0)
	{
	customer(pMsg);
...
void OnButtonClicked_T(WM_MESSAGE * pMsg)
{
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate_Home[] = {
    ...
    { BUTTON_CreateIndirect,    "手持限速器",             0x170,          150,107,218,49, 0,0},
    { BUTTON_CreateIndirect,    "台式限速器",             0x171,          412,107,218,49, 0,0},
    { BUTTON_CreateIndirect,    "测振加速度",             0x172,          150,187,218,49, 0,0},
    { BUTTON_CreateIndirect,    "平衡系数",              0x173,          412,187,218,49, 0,0},
    { BUTTON_CreateIndirect,    "时间设置",                 0x174,          150,273,218,49, 0,0},
    { BUTTON_CreateIndirect,    "触摸屏校准",                 0x175,          412,273,218,49, 0,0},
    { TEXT_CreateIndirect,      "电梯设备综合测试台",         0x160,            150,24, 152,16, 0,0},
    { TEXT_CreateIndirect,      "电梯设备公司",            0x800+11,            619,363,104,16, 0,0},
    { TEXT_CreateIndirect,      "w.xxx.com",         0x800+12,            643,389,80, 16, 0,0}
};
...
void InitDialog_Home(WM_MESSAGE * pMsg)
{
    ...
    TEXT_SetFont(WM_GetDialogItem(hWin,0x160),&GUI_FontHZ_SongTi_16);
...
{ 
    ...
    current_handle = GUI_CreateDialogBox(_aDialogCreate_Home, (sizeof(_aDialogCreate_Home) / sizeof(_aDialogCreate_Home[0])), &_cbCallback_Home, 0, 0, 0);
