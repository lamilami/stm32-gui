...
#line 12 "Source\\gui_app\\Balance.c"
...
#line 13 "Source\\gui_app\\Balance.c"
#line 14 "Source\\gui_app\\Balance.c"
#line 15 "Source\\gui_app\\Balance.c"
 ...
 void OnButtonBStartClicked(WM_MESSAGE * pMsg)
 {
	 ...
	 _BListBox[1]="Self";
	  ...
	  _BListBox[0]= buf;
	  LISTVIEW_InsertRow(WM_GetDialogItem(pMsg->hWin,0x800+11),0,_BListBox);
...
void  OnButtonBPrintClicked(WM_MESSAGE * pMsg)
{
 ...
 void OnButtonBRTClicked(WM_MESSAGE * pMsg)
 {
	...
	{
	BUTTON_SetText(WM_GetDialogItem(pMsg->hWin,0x800+4),"上升");
	tbalance_pars.dir = 2;
	}else {
	BUTTON_SetText(WM_GetDialogItem(pMsg->hWin,0x800+4),"下降");	
	tbalance_pars.dir = 1;
	}
...
{ FRAMEWIN_CreateIndirect,  "LIMIT_SPEED_H",     0,                       0,  0,  180,480,0,0},
    { BUTTON_CreateIndirect,    "保留1",              0x800+2,     1,  52, 100,40, 0,0},
    { BUTTON_CreateIndirect,    "停止",                0x800+3,     1,  190,100,40, 0,0},
    { BUTTON_CreateIndirect,    "上升/下降",             0x800+4,       1,  144,100,40, 0,0},
    ...
    { BUTTON_CreateIndirect,    "保留2",              0x800+9,      1,  98, 100,40, 0,0},
    { BUTTON_CreateIndirect,    "主界面",               0x800+10,     1,  420,100,40, 0,0},
    { LISTVIEW_CreateIndirect,   0,               0x800+11,        107,6,  68, 454,0,0},
    { BUTTON_CreateIndirect,    "升将开始",              0x800+1,     1,  6,  100,40, 0,0}
};
...
void InitDialog_B(WM_MESSAGE * pMsg)
{
	...
	LISTVIEW_AddColumn(WM_GetDialogItem(hWin,0x800+11),40,"M",(3<<2)|(0<<0));
	LISTVIEW_AddColumn(WM_GetDialogItem(hWin,0x800+11),5,"---",(3<<2)|(0<<0));
...
void get_result(void)
{
	...
	arm_matrix_instance_f32 MID;        
	arm_matrix_instance_f32 Y;        
	arm_matrix_instance_f32 END;       
    ...
    status = arm_mat_mult_f32(&ATMAI, &AT, &MID); 

	for(i=0;i<srcRows*3;i++)
		see[i] = mmen_e[i];

	  
    status = arm_mat_mult_f32(&MID, &Y, &END);
