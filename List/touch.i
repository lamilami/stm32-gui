...
#line 11 "Source\\uCGUI\\LCDDriver\\Touch\\Touch.c"
#line 1 "Source\\uCGUI\\LCDDriver\\Touch\\Touch.h"
...
#line 5 "Source\\uCGUI\\LCDDriver\\Touch\\Touch.h"
...
#line 6 "Source\\uCGUI\\LCDDriver\\Touch\\Touch.h"
...
#line 12 "Source\\uCGUI\\LCDDriver\\Touch\\Touch.c"
#line 1 ".\\Source\\uCGUI\\LCDDriver\\SSD1963.h"
#line 2 ".\\Source\\uCGUI\\LCDDriver\\SSD1963.h"
...
#line 13 "Source\\uCGUI\\LCDDriver\\Touch\\Touch.c"
...
#line 14 "Source\\uCGUI\\LCDDriver\\Touch\\Touch.c"
...
#line 15 "Source\\uCGUI\\LCDDriver\\Touch\\Touch.c"
...
#line 16 "Source\\uCGUI\\LCDDriver\\Touch\\Touch.c"
...
#line 161 "Source\\uCGUI\\LCDDriver\\Touch\\Touch.c"
...
{	
#line 235 "Source\\uCGUI\\LCDDriver\\Touch\\Touch.c"
}
...
void Pen_Int_Set(u8 en)
{
	if(en)((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR|=1<<7;   
	else ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR&=~(1<<7); 
}
...
#line 343 "Source\\uCGUI\\LCDDriver\\Touch\\Touch.c"
...
{ 
 unsigned char Data01 = 0; 
  ...
  SPI_I2S_ReceiveData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)));
  SPI_I2S_SendData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)),data); 

   
  while(SPI_I2S_GetFlagStatus(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)),((uint16_t)0x0001))==RESET); 
  
  Data01 = SPI_I2S_ReceiveData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))); 
...
{ 
   u16 x=0;
   GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0008));
   SpiDelay(10);
   SPI_WriteByte(0xd0);
   SpiDelay(10);
   ...
   x+=SPI_WriteByte(0x00);
   SpiDelay(20);
   GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0008));
...
unsigned int get_calibrate_state(void)
{
   return  (*(volatile uint16_t*)((uint32_t)0x080FF800)); 
...
void get_calibrate_data(uint16_t* cal_data)
{
	...
	for(i=0;i<5;i++)
	{
	cal_data[i]= (*(volatile uint16_t*)(((uint32_t)0x080FF800)+i*2)); 
    } 
}
...
FLASH_Status  save_calibrate_to_flash(uint16_t* data)
{
    ...
    return flash_pro(((uint32_t)0x080FF800), data,5);
}
...
uint8_t TOUCH_ReadAdcXY(uint16_t *_usX, uint16_t *_usY) 
{
    ...
    iY1 = TOUCH_DataFilter(2);
    iX1 = TOUCH_DataFilter(1);
    iY2 = TOUCH_DataFilter(2);
    iX2 = TOUCH_DataFilter(1);
