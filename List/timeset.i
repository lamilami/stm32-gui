#line 1 "Source\\gui_app\\TimeSet.c"
...
#line 12 "Source\\gui_app\\TimeSet.c"

#line 21 "Source\\gui_app\\TimeSet.c"
...
void OnEditClicked(WM_MESSAGE * pMsg,int id)
{
 ...
 if(!keyboard_h.use_now)
	...
	WidgetLock(pMsg->hWin,LOCK,8,0x800,id);
	KeyBoard_Win(&keyboard_h);
	WidgetLock(pMsg->hWin,UNLOCK,8,0x800,id);
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate_TM[] = {
    ...
    { EDIT_CreateIndirect,       0,               0x800+1,        122,76, 75, 21, 0,0},
    { TEXT_CreateIndirect,       0,               0x160,            176,85, 0,  12, 0,0},
    { TEXT_CreateIndirect,      "年",                 0x800+11,            218,81, 24, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+2,       122,112,75, 21, 0,0},
    { TEXT_CreateIndirect,      "月",                 0x800+12,            218,117,24, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+3,        122,160,75, 21, 0,0},
    { TEXT_CreateIndirect,      "日",                 0x800+13,            218,160,24, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+4,        122,234,75, 21, 0,0},
    { TEXT_CreateIndirect,      "时",                 0x800+14,            218,239,24, 16, 0,0},
    { TEXT_CreateIndirect,      "分",                 0x800+15,            218,278,24, 16, 0,0},
    { TEXT_CreateIndirect,      "秒",                 0x800+16,            218,313,24, 16, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+5,         122,273,75, 21, 0,0},
    { EDIT_CreateIndirect,       0,               0x800+6,         122,308,75, 21, 0,0},
    { BUTTON_CreateIndirect,    "OK",                0x800+7,          402,262,83, 32, 0,0},
...
void InitDialog_TM(WM_MESSAGE * pMsg)
{
    ...
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+12),&GUI_FontHZ_SongTi_16);
    ...
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+14),&GUI_FontHZ_SongTi_16);
    ...
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+16),&GUI_FontHZ_SongTi_16);
	
	
	
	sprintf(buf,"%d",Tim.year);
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+1),buf);
	sprintf(buf,"%d",Tim.month);
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+2),buf);
	sprintf(buf,"%d",Tim.date);
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+3),buf);
	sprintf(buf,"%d",Tim.hour);
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+4),buf);
	sprintf(buf,"%d",Tim.min);
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+5),buf);
	sprintf(buf,"%d",Tim.sec);	
	EDIT_SetText(WM_GetDialogItem(hWin,0x800+6),buf);
...
{ 
    ...
    GUI_CreateDialogBox(_aDialogCreate_TM, (sizeof(_aDialogCreate_TM) / sizeof(_aDialogCreate_TM[0])), &_cbCallback_TM, 0, 0, 0);
