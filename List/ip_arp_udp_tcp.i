...
#line 19 "Source\\Net\\ip_arp_udp_tcp.c"
...
#line 20 "Source\\Net\\ip_arp_udp_tcp.c"
#line 1 "Source\\Net\\net.h"
...
#line 21 "Source\\Net\\ip_arp_udp_tcp.c"
...
static unsigned char seqnum=0xa; 
...
unsigned  int get_tcp_data_pointer(void)
{
    if (info_data_len)
    {
        return((unsigned  int)0x22+info_hdr_len);
    }
    else
    {
        return(0);
