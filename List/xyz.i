...
#line 13 "Source\\gui_app\\XYZ.c"

#line 15 "Source\\gui_app\\XYZ.c"
#line 16 "Source\\gui_app\\XYZ.c"
#line 17 "Source\\gui_app\\XYZ.c"
#line 18 "Source\\gui_app\\XYZ.c"
#line 19 "Source\\gui_app\\XYZ.c"
#line 20 "Source\\gui_app\\XYZ.c"
#line 21 "Source\\gui_app\\XYZ.c"
#line 22 "Source\\gui_app\\XYZ.c"
#line 23 "Source\\gui_app\\XYZ.c"
#line 24 "Source\\gui_app\\XYZ.c"
#line 25 "Source\\gui_app\\XYZ.c"
...
#line 26 "Source\\gui_app\\XYZ.c"
#line 27 "Source\\gui_app\\XYZ.c"
...
#line 32 "Source\\gui_app\\XYZ.c"
#line 33 "Source\\gui_app\\XYZ.c"
#line 1 "D:\\Keil_ARM\\ARM\\RV31\\INC\\stdio.h"
...
#line 34 "D:\\Keil_ARM\\ARM\\RV31\\INC\\stdio.h"
...
#line 125 "D:\\Keil_ARM\\ARM\\RV31\\INC\\stdio.h"
...
#line 944 "D:\\Keil_ARM\\ARM\\RV31\\INC\\stdio.h"



 
#line 34 "Source\\gui_app\\XYZ.c"
#line 35 "Source\\gui_app\\XYZ.c"
#line 36 "Source\\gui_app\\XYZ.c"
#line 1 "Source\\gui_app\\XYZ.h"
#line 2 "Source\\gui_app\\XYZ.h"
#line 1 "Source\\gui_app\\xyz_acc_para.h"
#line 2 "Source\\gui_app\\xyz_acc_para.h"
...
#line 37 "Source\\gui_app\\XYZ.c"
#line 1 "Source\\gui_app\\xyz_acc_para.h"
#line 2 "Source\\gui_app\\xyz_acc_para.h"

#line 38 "Source\\gui_app\\XYZ.c"
#line 39 "Source\\gui_app\\XYZ.c"
#line 40 "Source\\gui_app\\XYZ.c"



q15_t fir_coeffs[5][8]={
	{20,66,170,250,250,170,66,20},
	{19,65,170,258,258,170,65,19},
	{16,60,170,266,266,170,60,16},
	{4,39,165,304,304,165,39,4},  
	{-5,-23,99,442,442,99,-23,-5}
};
...
static const GUI_COLOR Colors[] = {
     0xFFFFFF,0x0000AA
};

static const GUI_LOGPALETTE Pal = {
  2,	 
  1, 	 
  &Colors[0]
};
...
static const unsigned char _arrow_right[] = {
  0x4,0x0,
  0x6,0x0,
  0x7,0x0,
  0x7,0x80,
...
static const unsigned char _arrow_left[] = {
  0x0,0x20,
  0x0,0x60,
  0x0,0xe0,
  0x1,0xe0,
...
static const GUI_BITMAP arrow_right = {
  16, 
  21, 
  2, 
  1, 
...
static const GUI_BITMAP arrow_left = {
  16, 
  21, 
  2, 
  1, 
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
    ...
    { BUTTON_CreateIndirect,    "参数设置",              0x800+1,      1,  6,  80, 30, 0,0},
    { BUTTON_CreateIndirect,    "Start",             0x800+2,     1,  46, 80, 30, 0,0},
    { BUTTON_CreateIndirect,    "Stop",              0x800+3,      1,  86, 80, 30, 0,0},
    { BUTTON_CreateIndirect,    "Auto",              0x800+4,      1,  126,80, 30, 0,0},
    { BUTTON_CreateIndirect,    "Z_FFT",             0x800+5,     1,  166,80, 30, 0,0},
    { BUTTON_CreateIndirect,    "时基A/B",             0x800+6,   1,  211,80, 30, 0,0},
    { BUTTON_CreateIndirect,    "显示AB",              0x800+8,1,  321,80, 30, 0,0},
    { BUTTON_CreateIndirect,    "还原",                0x800+9,   1,  361,80, 30, 0,0},
    { BUTTON_CreateIndirect,    "Print",             0x800+10,     1,  401,80, 30, 0,0},
    { BUTTON_CreateIndirect,    "Save",              0x800+11,      1,  441,80, 30, 0,0},
    { BUTTON_CreateIndirect,     0,               0x800+12,1,  262,34, 41, 0,0},
    { BUTTON_CreateIndirect,     0,               0x800+13,47, 262,34, 41, 0,0}
};
...
void InitDialog(WM_MESSAGE * pMsg)
{
    ...
    BUTTON_SetFont(WM_GetDialogItem(hWin,0x800+1),&GUI_FontHZ_SongTi_16);
    
    
    
    BUTTON_SetFont(WM_GetDialogItem(hWin,0x800+2),&GUI_FontHZ_SongTi_16);
    
    
    
    BUTTON_SetFont(WM_GetDialogItem(hWin,0x800+3),&GUI_FontHZ_SongTi_16);
    
    
    
    BUTTON_SetFont(WM_GetDialogItem(hWin,0x800+4),&GUI_FontHZ_SongTi_16);
    
    
    
    BUTTON_SetFont(WM_GetDialogItem(hWin,0x800+5),&GUI_FontHZ_SongTi_16);
    
    
    
    BUTTON_SetFont(WM_GetDialogItem(hWin,0x800+6),&GUI_FontHZ_SongTi_16);
    
    
    
    BUTTON_SetFont(WM_GetDialogItem(hWin,0x800+8),&GUI_FontHZ_SongTi_16);
    
    
    
    BUTTON_SetFont(WM_GetDialogItem(hWin,0x800+9),&GUI_FontHZ_SongTi_16);
    
    
    
    BUTTON_SetFont(WM_GetDialogItem(hWin,0x800+10),&GUI_FontHZ_SongTi_16);
    
    
    
    BUTTON_SetFont(WM_GetDialogItem(hWin,0x800+11),&GUI_FontHZ_SongTi_16);

    
	BUTTON_SetBitmapEx(WM_GetDialogItem(hWin,0x800+12),1,&arrow_left,8,10);
	BUTTON_SetBitmapEx(WM_GetDialogItem(hWin,0x800+12),0,&arrow_left,8,10);
	BUTTON_SetBitmapEx(WM_GetDialogItem(hWin,0x800+13),1,&arrow_right,10,10);
	BUTTON_SetBitmapEx(WM_GetDialogItem(hWin,0x800+13),0,&arrow_right,10,10);
}
...
{ 
	...
	current_interface = 104;




	Z_acc.acc_x_pose = 20;
	Z_acc.acc_y_pose = (23+128/2);

	X_acc.acc_x_pose = 20;
	X_acc.acc_y_pose = (23+128+128/2);

	Y_acc.acc_x_pose = 20;
	Y_acc.acc_y_pose = (23+128+128/2);
	...
	time_base_inital();
    current_handle = GUI_CreateDialogBox(_aDialogCreate, (sizeof(_aDialogCreate) / sizeof(_aDialogCreate[0])), &_cbCallback, 0, 0, 0);
}
...
void OnButtonZ_FFTClicked(WM_MESSAGE * pMsg)
{
	...
	signed short fft_buf[1024*2];

	in_fft = 1;
	get_za_data(fft_buf,1024*2);
	fftLen = 1024;
	ifftFlag = 0;
	bitReverseFlag = 1;
	
	arm_cfft_radix4_init_q15(&fft_S,fftLen,ifftFlag,bitReverseFlag);
	get_data_from_sd(fft_buf ,loc_A,loc_B, 1024*2,ONE_AXLE);
...
void OnButtonTickABClicked(WM_MESSAGE * pMsg)
{
	...
	{
		tick_ab = 0;
		BUTTON_SetText(WM_GetDialogItem(hWin,0x800+6),"时基B");
		time_base.choice_ab = CHOICE_B;
	}
	else 
	{
		tick_ab = 1;
		BUTTON_SetText(WM_GetDialogItem(hWin,0x800+6),"时基A");
...
void OnButtonRevivalClicked(WM_MESSAGE * pMsg)
{
	...
	if(in_fft == 0)
	{
		...
		GUI_ClearRect(0,0,685,402 - 23+80);
		BUTTON_SetText(WM_GetDialogItem(current_handle,0x800+9),"返回");
		for(i=0x800+1;i<0x800+13+1;i++)
		{
...
void OnButtonArrowLeftClicked(WM_MESSAGE * pMsg)
{
	...
	{
		if(time_base.B_pos - 5 > time_base.A_pos)	
		{
...
void OnButtonArrowRightClicked(WM_MESSAGE * pMsg)
{
	...
	if(time_base.choice_ab == CHOICE_A)
	{ 
		if(time_base.A_pos + 5 < time_base.B_pos)	
		{
			GUI_SetVLine(time_base.A_pos, 0,470,&time_base.A_color_value[0]);
			time_base.A_pos += 5;
			GUI_GetVLine(time_base.A_pos, 0,470,&time_base.A_color_value[0]);
...
void draw_scale_y(int x0, int y0,int y1)
{
	...
	{   
		if(i == 0) 
		{
			...
			GUI_DispStringAt("x_m/s",20+600 + 10,current_y-5);

			GUI_DispStringAt("0g",x0-15,current_y +128/2-2);
			GUI_DispStringAt("x_m/s",20+600 + 10,current_y +128/2-2);

			GUI_DispStringAt("-2g",x0-20,current_y +128-5);
			GUI_DispStringAt("x_m/s",20+600 + 10,current_y +128-5);
			GUI_DispStringAt("Z_a_v",20+600 + 10,current_y +128/2-2);
		}
		else if( i== 1)
		{
			current_size = 128;
			...
			GUI_DispStringAt("0g",x0-15,current_y +128/2-2);
			GUI_DispStringAt("XYa_m2/s",20+600 + 10,current_y +128/2-2);
			GUI_DispStringAt("-2g",x0-20,current_y +128-5);
		}
		else
		{
		...
		GUI_DrawHLine(current_y,x0,x0+600);
		...
		GUI_DrawHLine(current_y+4*(current_size/8),x0,x0+600);
		...
		tsepoint.end_point.x = tsepoint.start_point.x + 600;
...
void time_base_inital(void)
{
	time_base.A_pos = 20+5;
	time_base.B_pos = (20+600)-5;

	GUI_GetVLine(0, time_base.A_pos,(23 +128*2),&time_base.A_color_value[0]);
	GUI_GetVLine(0, time_base.B_pos,(23 +128*2),&time_base.B_color_value[0]);
...
void xyz_fir(void)
{
	...
	signed short mid_in_buf[2*32];
	signed short mid_out_buf[32];
	signed short *p_out,*p_in;
	
	in_fft = 1;
	get_data_lenth = abs(Z_acc.got_acc_num - Z_acc.used_acc_num);
	times = get_data_lenth/32;
	flag = 0;

	for(i=0;i<times;i++)
	{
		in_addr = (Z_acc.used_acc_num+32*i)&(1024-1);

		if((in_addr+2*32)> 1024)
		{
	 
	 	for(j=0;j<2*32;j++)
	 	{
	  	mid_in_buf[j]= Z_acc.acc_buf[(in_addr+j)&(1024-1)];
	 	}
		p_in = mid_in_buf;
		...
		out_addr = (tfilter_result.got_filter_acc_num+32*i)&(1024-1);
		...
		arm_fir_q15(&FIR_S,p_in,p_out,32);

		if(flag)
		{
			for(j=0;j<32;j++)
			{
		  	tfilter_result.filter_acc_buf[(out_addr+j)&(1024-1)] = mid_out_buf[j];
			}
		}
	}

	Z_acc.used_acc_num = Z_acc.used_acc_num + times*32;
	tfilter_result.got_filter_acc_num = tfilter_result.got_filter_acc_num + times*32;
}
...
void xyz_value_fir_to_graph(void)
{
	...
	acc_nums_of_one_pixel = tdisp_acc_struct.acc_nums_of_one_pixel;
		...
		{
			temp = tfilter_result.filter_acc_buf[tfilter_result.used_filter_acc_num & (1024-1)];
			tfilter_result.used_filter_acc_num++;
			for(i=1; i<acc_nums_of_one_pixel; i++)
			{
				if(temp < tfilter_result.filter_acc_buf[tfilter_result.used_filter_acc_num  & (1024-1)])
				{
					temp = tfilter_result.filter_acc_buf[tfilter_result.used_filter_acc_num  & (1024-1)];
				}
				tfilter_result.used_filter_acc_num++;
			...
			acc_buf[acc_nums+1] = 0-((temp&0x8000)|((temp)>>4));  
			acc_nums++;
		}
		
		if((acc_nums > 0)&&(Z_acc.acc_x_pose < (20+600)))
		{
			acc_buf[0] = last_acc;
...
void xyz_value_dir_to_graph(MMA845X_struct* _acc,GUI_COLOR col,EXYZ xyz)
{
	...
	GUI_SetColor(col);
		...
		{
			temp = _acc->acc_buf[_acc->used_acc_num & (1024 - 1)];
			_acc->used_acc_num++;

			for(i=1; i<acc_nums_of_one_pixel; i++)
			{
				if(temp < _acc->acc_buf[_acc->used_acc_num & (1024 - 1)])
				{
				   temp = _acc->acc_buf[_acc->used_acc_num & (1024 - 1)];
				}
				_acc->used_acc_num++;
		...
		if((acc_nums > 0)&&(_acc->acc_x_pose < (20+600)))
		{
...
void fir_init(int get_id)
{
	arm_fir_init_q15(&FIR_S,8,&fir_coeffs[get_id-1][0],&FIR_State[0],32);
}
...
void draw_fft_scale(void)
{
	...
	tscale.x_pix_size = 600-88;
	tscale.y_pix_size = 352;    
	...
	tscale.y_data_max = 352;

	tscale.x_data_max = 256;

	
	tsepoint.start_point.x = 20;
	tsepoint.start_point.y = (23 +128*2);
	tsepoint.end_point.x = tsepoint.start_point.x + 600-88;
	tsepoint.end_point.y = (23 +128*2);
	draw_scale(tsepoint,0xffff,0);		

	tsepoint.start_point.x = 20;
	tsepoint.start_point.y = (23 +128*2);
	tsepoint.end_point.x = 20;
	tsepoint.end_point.y = tsepoint.start_point.y - 352;
	draw_scale(tsepoint,0xffff,0);		
...
void view_fft(signed short* buf)
{
	...
	GUI_DrawGraph(data_buf,1024/2,20,(23 +128*2));
	GUI_SetColor(color);
	charge_button_fft_fun();
}
...
{
	int i;
	BUTTON_SetText(WM_GetDialogItem(current_handle,0x800+9),"FFT返回");
	
	for(i=0x800+1;i<0x800+13+1;i++)
	{
	WM_DisableWindow(WM_GetDialogItem(current_handle,i));
	}
	WM_EnableWindow(WM_GetDialogItem(current_handle,0x800+9));
	BUTTON_SetPressed(WM_GetDialogItem(current_handle,0x800+5),0);
}
...
int xyz_file_init(int status)
{
		...
		if(status)
		f_mount(0, &fs);									  
		res = f_open(&fsrc, "xyz_a.ld",0x10|0x02 |0x01) ;
		f_sync(&fsrc);
		...
		if(fsrc.fsize >  sizeof(xyz_file)+4)
		{
			...
			res = f_read(&fsrc,&last_fragment_start,sizeof(last_fragment_start),&bw);
			res = f_lseek(&fsrc,last_fragment_start);
			res = f_read(&fsrc,&xyz_file,sizeof(xyz_file),&bw); 
		}
		return 0;	
...
int xyz_head_save(void)
{
		...
		if(fsrc.fsize >  sizeof(xyz_file)+4)
		{
			xyz_file.fragment_start = fsrc.fsize; 
		}
		else
		{
			xyz_file.fragment_start = 0; 
		}
		res = f_write(&fsrc,&xyz_file,sizeof(xyz_file),&bw); 
...
int xyz_file_data_save(unsigned char *buf, unsigned int data_size)
{
	...
	unsigned int  bw;
	res = f_lseek(&fsrc, fsrc.fsize);
	res = f_write(&fsrc,buf,data_size,&bw); 
	return res;
...
void xyz_file_save_end(void)
{
	...
	unsigned int  bw;
	res = f_lseek(&fsrc, fsrc.fsize);
	res = f_write(&fsrc,&xyz_file.fragment_start ,4,&bw); 
	if(bw!=4 || (res != 0))	
	{
		while(1);
	}
...
int save_xyz(void)
{
	...
	{
		if((Z_acc.used_acc_num & (1024 - 1)) + tdisp_acc_struct.acc_nums_of_one_pixel > 1024)
		{
		 first_part = 1024 - (Z_acc.used_acc_num & (1024 - 1));
		 ...
		 xyz_data[i] =  Z_acc.acc_buf[Z_acc.used_acc_num & (1024 - 1)+i];
		 i++;
		 xyz_data[i] =  Z_acc.acc_buf[Z_acc.used_acc_num & (1024 - 1)+i];
