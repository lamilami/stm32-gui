...
#line 3 "Source\\gui_app\\Draw.c"

#line 5 "Source\\gui_app\\Draw.c"
...
#line 6 "Source\\gui_app\\Draw.c"

#line 8 "Source\\gui_app\\Draw.c"
#line 9 "Source\\gui_app\\Draw.c"
#line 10 "Source\\gui_app\\Draw.c"
#line 11 "Source\\gui_app\\Draw.c"

#line 1 ".\\Source\\uCGUI\\Widget\\BUTTON_Private.h"
...
#line 24 ".\\Source\\uCGUI\\Widget\\BUTTON_Private.h"
#line 25 ".\\Source\\uCGUI\\Widget\\BUTTON_Private.h"
...
#line 66 ".\\Source\\uCGUI\\Widget\\BUTTON_Private.h"
...
#line 13 "Source\\gui_app\\Draw.c"
#line 14 "Source\\gui_app\\Draw.c"
#line 15 "Source\\gui_app\\Draw.c"
#line 16 "Source\\gui_app\\Draw.c"
#line 17 "Source\\gui_app\\Draw.c"
...
void scale_set(TScale *tscale)
{
	...
	rem_tscale = tscale;
	rate_x = (tscale->x_data_max/tscale->x_pix_size)*5;
	rate_y = (tscale->y_data_max/tscale->y_pix_size)*5;
	
	GUI_DispStringAt(tscale->unit_x,tscale->disp_text_p0.x - 70,tscale->disp_text_p0.y);
	sprintf(buf,"%.3f",rate_x);
	GUI_DispStringAt(buf,tscale->disp_text_p0.x,tscale->disp_text_p0.y);
	
	GUI_DispStringAt(tscale->unit_y,tscale->disp_text_p1.x - 70,tscale->disp_text_p1.y);
...
void view_int(WM_MESSAGE * pMsg)
{
	...
	hButton = BUTTON_Create(720, 0, 80, 25, 1, (1<<1));
	...
	tsepoint.end_point.y = tsepoint.start_point.y - 128*2;
	draw_scale(tsepoint,0xffff,0);		

	GUI_SetColor(0xFF0000);
	GUI_DrawHLine(65,20,600);
}
...
#line 239 "Source\\gui_app\\Draw.c"
}
}
...
void Draw(WM_MESSAGE * pMsg)
{
	...
	get_return = arm_fir_init_q15(&S,8,&Coeffs_25hz[0],&State[0],32);
	...
	for(i=0;i< disp_size/32;i++)
	{
		arm_fir_q15(&S,data_in+32*i,data_out+32*i,32);
	}

	for(i=0;i<disp_size;i++)
	{
		data_in[i] = 0-(data_in[i]/35); 
		data_out[i] = 0-data_out[i];
	}
	
	GUI_DrawGraph(data_in,512,20,65);
	GUI_DrawGraph(data_out,512,20,65+200);
	


	
#line 386 "Source\\gui_app\\Draw.c"
