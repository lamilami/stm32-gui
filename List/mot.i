...
#line 3 "Source\\Mot\\mot.c"
#line 4 "Source\\Mot\\mot.c"
#line 5 "Source\\Mot\\mot.c"
...
#line 6 "Source\\Mot\\mot.c"


#line 10 "Source\\Mot\\mot.c"
...
void start_test_init()
{
	...
	list_view_color(3,0,0xFFFF80);

	}
 
	if((!mot_t_cal.cal_flag)&&(current_interface == 106))
	{
	...
	pars.pwm_acc = pars.start_speed*(1000/(((2*3.141592*pars . R_mm)*5)/1000));
...
void motor_int(void)
{
	...
	RCC_APB1PeriphClockCmd( ((uint32_t)0x00000002)|((uint32_t)0x00000001)|((uint32_t)0x00000004)|((uint32_t)0x00000008)|((uint32_t)0x00000020),ENABLE);
	RCC_AHBPeriphClockCmd(((uint32_t)0x00000001), ENABLE);
	RCC_APB2PeriphClockCmd( ((uint32_t)0x00000200)|((uint32_t)0x00000004)|((uint32_t)0x00000040)|((uint32_t)0x00000020)|((uint32_t)0x00000010)| ((uint32_t)0x00000001),ENABLE);
	  
	RCC_ADCCLKConfig(((uint32_t)0x00008000));     

	GPIO_PinRemapConfig(((uint32_t)0x001A0C00), ENABLE);
	...
	GPIO_EXTILineConfig(((uint8_t)0x04),((uint8_t)0x05)|((uint8_t)0x06));
  	EXTI_InitStructure_A.EXTI_Line = ((uint32_t)0x00020)|((uint32_t)0x00040); 
	...
	TIM_CtrlPWMOutputs(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ENABLE);

  	TIM_OCInitStructure.TIM_OCPolarity = ((uint16_t)0x0002);
  	TIM_OCInitStructure.TIM_OCNPolarity = ((uint16_t)0x0000);
  	TIM_OCInitStructure.TIM_OCIdleState = ((uint16_t)0x0100);
  	TIM_OCInitStructure.TIM_OCNIdleState = ((uint16_t)0x0000);

	TIM_OC1Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)),&TIM_OCInitStructure);  
    ...
    TIM_ICInitStructure.TIM_ICPolarity = ((uint16_t)0x0002);
    TIM_ICInitStructure.TIM_ICSelection = ((uint16_t)0x0001);
    TIM_ICInitStructure.TIM_ICPrescaler = ((uint16_t)0x0000);
    TIM_ICInitStructure.TIM_ICFilter = 0x0;

    TIM_ICInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), &TIM_ICInitStructure);
  	TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ENABLE);
...
#line 295 "Source\\Mot\\mot.c"
    ...
    TIM_TimeBaseStructure.TIM_ClockDivision = 0;
    TIM_TimeBaseStructure.TIM_CounterMode = ((uint16_t)0x0000);
    TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400)), &TIM_TimeBaseStructure);
	TIM_ITConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400)), ((uint16_t)0x0001), ENABLE);
...
void motor_dir(int dir)
{
	...
	if(dir == 0)
	{
	 GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0001));
	 GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x8000));
	 motor_speed(0);
	}else if(dir == 1){
	 GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0001));
	 GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x8000));	
	}else if(dir == 2){
	 GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0001));
	 GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x8000));	
	}
...
void motor_speed(int pwm_speed)
{
	...
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800))->CCR1 = 8000 - pwm_speed*8;
...
unsigned int i;
  ...
  if((TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0002)) == SET)&&(TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0001)) != SET)) 
  {
  	for(i=0;i<1500;i++)	 
	{
	  if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0001))!=0)
	   {
	 ...
	 if(last_cap_value == 0)
	{
	  last_cap_value = time_up*0x10000+TIM_GetCapture1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)));
	  last_speed = 0;

	}else{
	  current_cap_value = time_up*0x10000+ TIM_GetCapture1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)));
  ...
  }else if((TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0001)) == SET)&&(TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0002)) != SET))
  {
	time_up++;
	TIM_ClearITPendingBit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0001));

  }else if((TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0002)) == SET)&&(TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0001)) == SET))
  {
	 if(current_cap_value > 0xfff0)
	 {
	 current_cap_value = time_up*0x10000 + TIM_GetCapture1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)));
	 }else{
	 current_cap_value = (time_up+1)*0x10000 + TIM_GetCapture1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)));
	 }
	 if(last_cap_value == 0)
	{
	  last_cap_value = time_up*0x10000+TIM_GetCapture1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)));
...
void TIM7_Interrupt(void)
{
	...
	if(get_data.sw1_speed > tspeed_buf.speed_buf[tspeed_buf.in_loc&(512-1)])
	{
...
float cir; 
    ...
    current_frequence  = ((2000000)*100)/(bt_data);
	...
	cir = ((2*3.14159*pars . R_mm)*2000000)/(bt_data); 
	...
	get_data.time_us = get_data.time_us + 0.5*bt_data;

	tspeed_buf.speed_buf[tspeed_buf.in_loc&(512-1)] = get_data.speed;
	tspeed_buf.in_loc++;
...
int one_stop()
{
	int max;
	  ...
	  if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0020))!=init_sw1_state && GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0040))!= init_sw2_state)
	  	{
...
void judge_result()
{
 ...
 pass_limit =  (1.15*pars . ve);
 pass_max =   (1.15*pars . ve + 0.25/pars . ve);
...
char intit_sw_state()
{
	 ...
	 if(record.test_times == 1)
		{
		init_sw1_state = GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0020));
		init_sw2_state = GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0040));
		return 1;
		}else{
		sw1_st1 = GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0020));
		sw2_st2 = GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0040));
...
void EXIT9_5()
{
   ...
   if(EXTI_GetITStatus(((uint32_t)0x00020)) != RESET)
  {
  	EXTI_ClearITPendingBit(((uint32_t)0x00020));
	  	if((GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0020)) != init_sw1_state)&&(!sw1_already_oper))
	{
		for(i=0;i<1000;i++)
		{
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0020)) == init_sw1_state )
		{
	  ...
	  one_stop();
	   ...
	   TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400)), ENABLE);
	  }
	}

  }else if(EXTI_GetITStatus(((uint32_t)0x00040)) != RESET)
  {
    EXTI_ClearITPendingBit(((uint32_t)0x00040));
  	if((GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0040)) != init_sw2_state)&&(!sw2_already_oper))
	{
		for(i=0;i<1000;i++)
		{
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0040)) == init_sw2_state )
		{
		return;
		}
		}
