...
#line 426 ".\\Source\\FWLib\\inc\\stm32f10x_dma.h"
...
#line 23 "Source\\FWLib\\src\\stm32f10x_dma.c"
#line 24 "Source\\FWLib\\src\\stm32f10x_dma.c"
...
#line 54 "Source\\FWLib\\src\\stm32f10x_dma.c"
...
void DMA_ClearFlag(uint32_t DMA_FLAG)
{
  ...
  if ((DMA_FLAG & ((uint32_t)0x10000000)) != (uint32_t)RESET)
  {
    ...
    ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0400))->IFCR = DMA_FLAG;
  }
  else
  {
     
    ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0000))->IFCR = DMA_FLAG;
  }
}
...
void DMA_ClearITPendingBit(uint32_t DMA_IT)
{
  ...
  if ((DMA_IT & ((uint32_t)0x10000000)) != (uint32_t)RESET)
  {
    ...
    ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0400))->IFCR = DMA_IT;
  }
  else
  {
     
    ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0000))->IFCR = DMA_IT;
  }
}
