...
#line 413 ".\\Source\\FWLib\\inc\\stm32f10x_flash.h"
...
#line 23 "Source\\FWLib\\src\\stm32f10x_flash.c"
...
#line 66 "Source\\FWLib\\src\\stm32f10x_flash.c"

 
#line 74 "Source\\FWLib\\src\\stm32f10x_flash.c"
...
void FLASH_Unlock(void)
{
  ...
  ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->KEYR2 = ((uint32_t)0x45670123);
  ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->KEYR2 = ((uint32_t)0xCDEF89AB);
...
void FLASH_Lock(void)
{
  ...
  ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR2 |= ((uint32_t)0x00000080);
...
FLASH_Status FLASH_ErasePage(uint32_t Page_Address)
{
  ...
  if(Page_Address < ((uint32_t)0x807FFFF))  
  {
  ...
  else
  {
    ...
    status = FLASH_WaitForLastBank2Operation(((uint32_t)0x000B0000));
    if(status == FLASH_COMPLETE)
    { 
       
      ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR2|= ((uint32_t)0x00000002);
      ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->AR2 = Page_Address; 
      ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR2|= ((uint32_t)0x00000040);
    
       
      status = FLASH_WaitForLastBank2Operation(((uint32_t)0x000B0000));
      
       
      ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR2 &= ((uint32_t)0x00001FFD);
    }
  }
#line 479 "Source\\FWLib\\src\\stm32f10x_flash.c"
...
FLASH_Status FLASH_EraseAllPages(void)
{
  ...
  if(status == FLASH_COMPLETE)
  {
     ...
     ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR2 |= ((uint32_t)0x00000004);
     ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR2 |= ((uint32_t)0x00000040);
    ...
    ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR2 &= ((uint32_t)0x00001FFB);
  }
#line 539 "Source\\FWLib\\src\\stm32f10x_flash.c"
...
FLASH_Status FLASH_ProgramWord(uint32_t Address, uint32_t Data)
{
  ...
  { 
    ...
    status = FLASH_WaitForLastBank1Operation(((uint32_t)0x00002000)); 
    if(status == FLASH_COMPLETE)
    {
  ...
  else if(Address == (((uint32_t)0x807FFFF) - 1))
  {
    ...
    status = FLASH_WaitForLastBank2Operation(((uint32_t)0x00002000));

    if(status == FLASH_COMPLETE)
    {
      
 
      ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR2 |= ((uint32_t)0x00000001);
      tmp = Address + 2;
      ...
      *(volatile uint16_t*) tmp = Data >> 16;
      ...
      ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR2 &= ((uint32_t)0x00001FFE);
    }
    else
    {
...
#line 844 "Source\\FWLib\\src\\stm32f10x_flash.c"
...
#line 914 "Source\\FWLib\\src\\stm32f10x_flash.c"
...
{ 
  ...
  {  
    ...
    if(FLASH_BOOT == ((uint16_t)0x0000))
    {
      ((OB_TypeDef *) ((uint32_t)0x1FFFF800))->USER |= ((uint16_t)0x0008);
    }
    else
    {
      ((OB_TypeDef *) ((uint32_t)0x1FFFF800))->USER &= (uint16_t)(~(uint16_t)(((uint16_t)0x0008)));
    }
...
void FLASH_ITConfig(uint32_t FLASH_IT, FunctionalState NewState)
{
  ...
  if((FLASH_IT & 0x80000000) != 0x0)
  {
    if(NewState != DISABLE)
    {
      ...
      ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR2 |= (FLASH_IT & 0x7FFFFFFF);
    }
    else
    {
       
      ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CR2 &= ~(uint32_t)(FLASH_IT & 0x7FFFFFFF);
    }
  }
  else
  {
...
#line 1338 "Source\\FWLib\\src\\stm32f10x_flash.c"
}
...
FlagStatus FLASH_GetFlagStatus(uint32_t FLASH_FLAG)
{
  ...
  else
  {
    ...
    {
      if((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->SR2 & FLASH_FLAG) != (uint32_t)RESET)
      {
        bitstatus = SET;
      }
      else
...
#line 1425 "Source\\FWLib\\src\\stm32f10x_flash.c"
...
void FLASH_ClearFlag(uint32_t FLASH_FLAG)
{
  ...
  if((FLASH_FLAG & 0x80000000) != 0x0)
  {
    ...
    ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->SR2 = FLASH_FLAG;
  }
  else
  {
...
#line 1466 "Source\\FWLib\\src\\stm32f10x_flash.c"
}
...
FLASH_Status FLASH_GetBank2Status(void)
{
  ...
  if((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->SR2 & (((uint32_t)0x80000001) & 0x7FFFFFFF)) == (((uint32_t)0x80000001) & 0x7FFFFFFF)) 
  {
    flashstatus = FLASH_BUSY;
  }
  else 
  {  
    if((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->SR2 & (((uint32_t)0x80000004) & 0x7FFFFFFF)) != 0)
    { 
      flashstatus = FLASH_ERROR_PG;
    }
    else 
    {
      if((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x2000))->SR2 & (((uint32_t)0x80000010) & 0x7FFFFFFF)) != 0 )
      {
        flashstatus = FLASH_ERROR_WRP;
      }
      else
...
{ 
  ...
  while((status == (((uint32_t)0x80000001) & 0x7FFFFFFF)) && (Timeout != 0x00))
  {
    status = FLASH_GetBank2Status();
    Timeout--;
  }
