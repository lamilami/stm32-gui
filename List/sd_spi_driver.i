...
#line 39 "Source\\SDHC\\driver\\sd_spi_driver.c"
 

 	
#line 56 "Source\\SDHC\\driver\\sd_spi_driver.c"
...
#line 83 "Source\\SDHC\\driver\\sd_spi_driver.c"
...
#line 98 "Source\\SDHC\\driver\\sd_spi_driver.c"
...
void sd_low_level_Init(void)
{
    ...
    SPI_I2S_DeInit(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00))); 

    RCC_APB2PeriphClockCmd(((uint32_t)0x00000010) | ((uint32_t)0x00000008) | ((uint32_t)0x00000008) |((uint32_t)0x00000008) , ENABLE);
    ...
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0800));
    ...
    SPI_InitStructure.SPI_BaudRatePrescaler = ((uint16_t)0x0038);
    ...
    SPI_I2S_ReceiveData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)));
    while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002)) == RESET);
    SPI_I2S_ReceiveData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)));

    *((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) &0xFFFFF)<<5)+(11<<2))))=1;
...
void sd_spi_speed(u8 SPI_BaudRate)
 {
    ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00))->CR1&=0XFFC7;
	((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00))->CR1|=SPI_BaudRate;	
	SPI_Cmd(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)),ENABLE); 
 }
...
{					 	
	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0002)) == RESET); 		  
	SPI_I2S_SendData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), TxData); 
	while (SPI_I2S_GetFlagStatus(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), ((uint16_t)0x0001)) == RESET);					    
	return SPI_I2S_ReceiveData(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00))); 				    
}
...
u8 SD_Select(void)
{
	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) &0xFFFFF)<<5)+(11<<2))))=0;
	if(SD_WaitReady()==0)
    {
        return 0;
    }
