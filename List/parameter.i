#line 1 "Source\\gui_app\\Parameter.c"
...
#line 12 "Source\\gui_app\\Parameter.c"
#line 1 "Source\\gui_app\\KeyBoard.h"
...
#line 13 "Source\\gui_app\\Parameter.c"



#line 17 "Source\\gui_app\\Parameter.c"
...
#line 36 "Source\\gui_app\\Parameter.c"
	



		
#line 48 "Source\\gui_app\\Parameter.c"
...
void OnButtonClicked_Lim(WM_MESSAGE * pMsg)
{
	...
	pars.ve = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+14));
	
	pars.R_mm = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+16));
	
	pars.start_speed = EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+2));

	pars.v1=  EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+4));
		
	pars.v2=  EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+6));
		
	pars.ak1=  EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+8));
	
	pars.ak2= EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+10));
	
	pars.ak3=  EDIT_GetFloatValue(WM_GetDialogItem(pMsg->hWin, 0x800+12));
...
{
	disp_mult = CHECKBOX_GetState(WM_GetDialogItem(pMsg->hWin,0x800+25));
}
	...
	static const GUI_WIDGET_CREATE_INFO _aDialogCreate_Par[] = {
		...
		{ TEXT_CreateIndirect,		"额定速度", 		 0x800+13,		  102,44, 72, 16, 0,0},
		{ EDIT_CreateIndirect,		 0,				 0x800+14,		  209,39, 70, 21, 0,5},
		{ TEXT_CreateIndirect,		"m/s",				 0x800+11,			  295,42, 23, 12, 0,0},

		{ TEXT_CreateIndirect,		"节经", 		     0x800+15,		   134,82, 40, 16, 0,0},
		{ EDIT_CreateIndirect,		 0,				 0x800+16, 		  209,77, 70, 21, 0,5},
		{ TEXT_CreateIndirect,		"mm",				 0x800+11,			  295,86, 17, 12, 0,0},

		
		{ TEXT_CreateIndirect,		"初速度",			 0x800+1, 		 118,121,56, 16, 0,0},
		{ EDIT_CreateIndirect,		 0,				 0x800+2,		  209,121,70, 21, 0,5},
		{ TEXT_CreateIndirect,		"m/s",				 0x800+11,			  295,125,23, 12, 0,0},

		{ TEXT_CreateIndirect,		"速度V1",			 0x800+3, 		118,164,56, 16, 0,0},
		{ EDIT_CreateIndirect,		 0,				 0x800+4,		  209,159,70, 21, 0,5},
		{ TEXT_CreateIndirect,		"m/s",				 0x800+11,			  295,164,23, 12, 0,0},

		{ TEXT_CreateIndirect,		"速度V2",			 0x800+5, 		118,204,56, 16, 0,0},
		{ EDIT_CreateIndirect,		 0,				 0x800+6,		  209,199,70, 21, 0,5},
		{ TEXT_CreateIndirect,		"m/s",				 0x800+11,			  295,204,23, 12, 0,0},

		{ TEXT_CreateIndirect,		"加速度A1", 	     0x800+7, 		 102,245,72, 16, 0,0},
		{ EDIT_CreateIndirect,		 0,				 0x800+8,		  209,240,70, 21, 0,5},
		{ TEXT_CreateIndirect,		"m2/s", 			 0x800+11,			  295,249,29, 12, 0,0},
		
		{ TEXT_CreateIndirect,		"加速度A2", 		 0x800+9, 		 102,291,72, 16, 0,0},
		{ EDIT_CreateIndirect,		 0,				 0x800+10,		  209,286,70, 21, 0,5},
		{ TEXT_CreateIndirect,		"m2/s", 			 0x800+11,			  295,295,29, 12, 0,0},
		
		{ TEXT_CreateIndirect,		"加速度A3", 		 0x800+21, 		 102,328,72, 16, 0,0},
		{ EDIT_CreateIndirect,		 0,				 0x800+12,		  209,323,70, 21, 0,5},
		{ TEXT_CreateIndirect,		"m2/s", 			 0x800+11,			  295,326,29, 12, 0,0},


		{ TEXT_CreateIndirect,		"限流值",			 0x800+24,		 126,366,48, 16, 0,0},
		{ EDIT_CreateIndirect,		 0,				 0x800+18,			209,361,70, 21, 0,5},
		{ TEXT_CreateIndirect,		"mA",				 0x800+11,			 295,366,23, 12, 0,0},
		
		{ TEXT_CreateIndirect,		"保留1",			 0x800+20,		  126,399,48, 16, 0,0},
		{ TEXT_CreateIndirect,		 0,				 0x800+11,	   102,359,0,  16, 0,5},
		{ TEXT_CreateIndirect,		"xxx",				 0x800+11,			  295,404,23, 12, 0,0},

		{ BUTTON_CreateIndirect,	"OK",				 0x800+22,			585,400,88, 42, 0,0},
	
		{ CHECKBOX_CreateIndirect,  "多曲线显示",        0x800+25,     498,35, 78, 16, 0,0},
...
void InitDialog_Par(WM_MESSAGE * pMsg)
{
    ...
    FRAMEWIN_AddCloseButton(hWin, (1<<0), 0);
    FRAMEWIN_AddMaxButton(hWin, (1<<0), 1);
    FRAMEWIN_AddMinButton(hWin, (1<<0), 2);
    
    
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+1),&GUI_FontHZ_SongTi_16);
    
    
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+3),&GUI_FontHZ_SongTi_16);
    
    
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+5),&GUI_FontHZ_SongTi_16);
    
    
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+7),&GUI_FontHZ_SongTi_16);
    
    
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+9),&GUI_FontHZ_SongTi_16);
    
    
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+9),&GUI_FontHZ_SongTi_16);

	TEXT_SetFont(WM_GetDialogItem(hWin,0x800+21),&GUI_FontHZ_SongTi_16);
    
    
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+15),&GUI_FontHZ_SongTi_16);
    
    
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+13),&GUI_FontHZ_SongTi_16);
    
    
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+11),&GUI_FontHZ_SongTi_16);
    
    
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+19),&GUI_FontHZ_SongTi_16);
    
	
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+20),&GUI_FontHZ_SongTi_16);
    
    
    
    TEXT_SetFont(WM_GetDialogItem(hWin,0x800+9),&GUI_FontHZ_SongTi_16);
	
	TEXT_SetFont(WM_GetDialogItem(hWin,0x800+17),&GUI_FontHZ_SongTi_16);

	TEXT_SetFont(WM_GetDialogItem(hWin,0x800+24),&GUI_FontHZ_SongTi_16);
	...
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+8),6);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+10),6);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+12),6);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+18),6);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+16),6);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+2),6);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+4),6);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+6),6);
	EDIT_SetMaxLen(WM_GetDialogItem(hWin,0x800+14),6);
	
	
	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+8),pars.ak1,0,99999,3,2);

	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+10),pars.ak2,0,99999,3,2);

	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+12),pars.ak3,0,99999,2,2);

	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+18),pars.limit_current_h,0,9999,2,2);

	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+16),pars.R_mm,0,9999,2,2);

	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+2),pars.start_speed,0,9999,2,2);

	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+4),pars.v1,0,9999,2,2);

	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+6),pars.v2,0,9999,2,2);

	EDIT_SetFloatMode(WM_GetDialogItem(hWin,0x800+14),pars.ve,0,9999,2,2);

	 
    CHECKBOX_SetFont(WM_GetDialogItem(hWin,0x800+25),&GUI_FontHZ_SongTi_16);
	CHECKBOX_SetText(WM_GetDialogItem(hWin,0x800+25),"多曲线显示");
	
    if(disp_mult)
	{
		CHECKBOX_SetState(WM_GetDialogItem(hWin,0x800+25), 1);
	}
        ...
        case 38:
            ...
            switch (Id) 
            {
				...
				case 0x800+18:
					...
					if(NCode==2)
					{
					UseKeyBoard(pMsg,0x800+24 - 0x800+1+1,0x800,Id,SFLOAT);
					break;
					}
...
{ 
    ...
    current_handle = GUI_CreateDialogBox(_aDialogCreate_Par, (sizeof(_aDialogCreate_Par) / sizeof(_aDialogCreate_Par[0])), &_cbCallback_Par, 0, 0, 0);
