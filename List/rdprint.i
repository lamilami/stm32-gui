...
#line 2 "Source\\BSP\\rdprint.c"
#line 3 "Source\\BSP\\rdprint.c"


void rdprint(char data)
{

  USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),data);
  while(USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0080)) == RESET)
  {
  }
  while(USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))) == 0x13)
  {
