...
#line 143 ".\\Source\\FWLib\\inc\\stm32f10x_pwr.h"
...
#line 23 "Source\\FWLib\\src\\stm32f10x_pwr.c"
#line 24 "Source\\FWLib\\src\\stm32f10x_pwr.c"
...
void PWR_EnterSTOPMode(uint32_t PWR_Regulator, uint8_t PWR_STOPEntry)
{
  ...
  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= ((uint8_t)0x04);
  ...
  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR &= (uint32_t)~((uint32_t)((uint8_t)0x04));  
}
