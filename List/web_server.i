...
#line 20 "Source\\Net\\web_server.c"
...
#line 21 "Source\\Net\\web_server.c"
#line 1 "Source\\Net\\net.h"
...
#line 22 "Source\\Net\\web_server.c"
#line 1 "Source\\Net\\web_server.h"
...
#line 23 "Source\\Net\\web_server.c"
...
#line 24 "Source\\Net\\web_server.c"
...
#line 27 "Source\\Net\\web_server.c"
...
static unsigned char buf[1500+1];
...
unsigned int print_webpage(unsigned char *buf,unsigned char on_off)
{
    ...
    plen=fill_tcp_data_p(buf,plen,"<center><p> LED状态指示: ");
    ...
    if (on_off)
    {
        plen=fill_tcp_data_p(buf,plen,"/0\">关闭</a><p>");
    }
    else
    {
        plen=fill_tcp_data_p(buf,plen,"/1\">开启</a><p>");
    }
    plen=fill_tcp_data_p(buf,plen,"</center><hr><br>****************^_^ 欢迎您登入 xxx 电梯 用 测试平台 ^_^****************\n");
...
{   
  ...
  {  
      ...
      plen = enc28j60PacketReceive(1500, buf);      
      ...
      if (buf[0x17]==6&&buf[0x24]==0&&buf[0x25]==mywwwport)
      {
          if (buf[0x2f] & 2)
          {
	 ...
	 if (buf[0x17]==17&&buf[0x24]==0x00&&buf[0x25]==0x45)
	 {
