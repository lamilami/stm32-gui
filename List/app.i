...
#line 36 "Source\\APP\\app.c"

 
 OS_STK AppTaskStartStk[128];
__align(8) static  OS_STK AppTaskUserIFStk[256+256+1024];
 OS_STK AppTaskKbdStk[256+256];

 OS_STK AppTaskNetStk[256];
...
OSTaskCreateExt(AppTaskStart,(void *)0,(OS_STK *)&AppTaskStartStk[128-1],3,3,(OS_STK *)&AppTaskStartStk[0],128,(void *)0,0x0001u|0x0002u);
...
static  void  AppTaskCreate(void)
{
  ...
  OSTaskCreateExt(AppTaskUserIF,(void *)0,(OS_STK *)&AppTaskUserIFStk[256+256+1024-1],5,5,(OS_STK *)&AppTaskUserIFStk[0],
                    256+256+1024,
                    (void *)0,
                    0x0001u|0x0002u);
  ...
  OSTaskCreateExt(AppTaskKbd,(void *)0,(OS_STK *)&AppTaskKbdStk[256+256-1],4,4,(OS_STK *)&AppTaskKbdStk[0],
                    256+256,
                    (void *)0,
                    0x0001u|0x0002u);


  OSTaskCreateExt(AppTaskNet,(void *)0,(OS_STK *)&AppTaskNetStk[256-1],7,7,(OS_STK *)&AppTaskNetStk[0],
                    256,
                    (void *)0,
                    0x0001u|0x0002u);
   ...
   while(1) 
     {
		...
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0010)) == 0)
		{
		FT5x06_GetData(&x,&y);
		pid_state.Pressed = 1;
		pid_state.x = x;
